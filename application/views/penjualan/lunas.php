                ...
                <div>	<h2 class="title">penjualan</h2>
                    <div class="entry">
						...
						<input type="hidden" name="halaman"  value="lunas">
                            ...
                            <?php 
                                //model yang ditempelkan di view
                                    if(isset($scan_modul)){
                                        echo $scan_modul;
                                    }
                                ?>
                            <?php 
                                //ambil view dari penjualan data member
                                $this->load->view('penjualan/datamember');
                                ?>
                            <table width="685" border="0" id="data" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;<select name="intid_jpenjualan" id="intid_jpenjualan" onchange="()">
