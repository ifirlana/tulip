...
<div id="page1">
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">Combo123</h2>
		<div>
                    <div id="entry" class="entry" >
                        <form action="<?php echo base_url()?>penjualan/combo_after123" method="post" name="frmjual" id="frmjual">
				...
				<tr>
					...
					<td><input type="hidden" name="chkSmart" id="chkSmart" />
                           ...
                           <?php $this->load->view("penjualan/combo/submenu_dp");?>                            
                            <table id="data">
                                <tr>
