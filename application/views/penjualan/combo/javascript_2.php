...
////////////////untuk meload categoy promo combo
    ...
    function load_db_promo_combo(){
        ...
        $(".id1").autocomplete({
                ...
                function(req, add){
                    $.ajax({
                        url: "<?php echo base_url(); ?>combo_controller/lookupBarangPromoCombo",
                        dataType: 'json',
                        type: 'POST',
                        data: {
                                term: req.term,
    ...
    function load_db_promo_combo_free(){
        $(".id1").autocomplete({
                ...
                function(req, add){
                    $.ajax({
                        url: "<?php echo base_url(); ?>combo_controller/lookupBarangPromoComboFree",
                        dataType: 'json',
                        type: 'POST',
                        data: {
                                term: req.term,
    ...
    function addBrg_combo(){
			 ...
			 console.log("addBrg_combo  active");
    ...
    function hitung_combo(id){
        ...
        */
        ...
        if(total > batasCombo){//kondisi jika melebihi qouta
