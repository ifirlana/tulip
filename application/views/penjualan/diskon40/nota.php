    ...
    <div id="wrapper">
		...
		function promo50(ID,num,id_cabang,track){
			...
			$("#metal_6").attr("disabled","disabled");
                        $("#result001").empty();
                        $("#result001").append(
                        	"<input type='text' align='top' id='strkode_dealer' name='strkode_dealer' value='" + ui.item.id + "' readonly/><br><td><input type='text' id='strkode_upline' name='strkode_upline' value='" + ui.item.value2 + "' size='30' readonly/><input type='hidden' id='intid_dealer' name='intid_dealer' value='" + ui.item.intid_dealer + "' size='30' readonly/><input type='hidden' size='2' id='pengejaranChall' value='"+ui.item.challhut+"' readonly></td>"
			);			
...
////////////////////////////////////////////////////////
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">promo diskon 40% Pilihan</h2>
                    <div class="entry">
                        <form id="form-action" action="<?php echo base_url()?>penjualan/nota" method="post" name="frmjual" id="frmjual">
						<input type="hidden" name="halaman"  value="lunas">
                         <input type="hidden" name="intid_week" readonly="readonly" value="<?php echo $intid_week; ?>">
                        <input type="hidden" name="is_dp" id="is_dp" readonly="readonly" value="0">
                        <input type="hidden" name="datetgl" readonly="readonly" value="<?php echo date("Y-m-d"); ?>">
                           <div id="error"><?php echo validation_errors(); ?></div>
                            <table width="685" border="0" id="data" align="center">
                                ...
                                <tr>
                                    <td>&nbsp;No. Nota</td>
                                    <td>&nbsp;<input type="hidden" id="dp_name" name="dp_name" size="20" value="" readonly >
									<span id="dp_code"></span>
									<input type="text" id="nomor_nota" name="intno_nota" size="20" value="<?php echo $max_id?>" readonly ></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;<input type="hidden" name="intid_jpenjualan" value="" id="post_intid_jpenjualan"/><select id="intid_jpenjualan">
                                    ...
                                    <td>
                                        <style="display:none;" input type="checkbox" name="chkBox20" id="chkBox20" disabled="disabled"/>
                                ...
                                <tr style="display:none;">
                                    ...
                                    <td >
                                        <style="display:none;" input type="checkbox" name="chkBox10" id="chkBox10" disabled="disabled"/>
...
<!-- //999 -->
							  ...
							  */
                              ...
                              <tr id="showattrlainlain3">
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
									<td colspan="3">Tulip 50% komisi 10%</td>
									<td ><input type="checkbox" name="chktulip50_10" id="chktulip50_10"  <?php if($id_cabang == 28 or $id_cabang == 9){?><?php }else{?>disabled<?php }?>/>
                                    </td>
                                </tr>
								<tr id="showattrlainlain3">
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
									<td colspan="3">40% Voucher Metal</td>
									<td ><input type="checkbox" name="chkvochermetal" id="chkvochermetal"  />
                                    </td>
                                </tr>
								<tr>
									<td style='width:10%;'>&nbsp;</td>
														<td style='width:70%;'>&nbsp;</td>
									<td style='width:10%;'>DP</td>
									<td><input  type='checkbox'  id="DP"/></td>
                                </tr>	
								<?php
								if($id_cabang == 1){
								?>
								<tr>
									<td style='width:10%;'>&nbsp;</td>
														<td style='width:70%;'>&nbsp;</td>
									<td style='width:10%;'>voucher</td>
									<td><input  type='checkbox'  id="chkvoucher40"/></td>
                                </tr>	
									<?php
									}
								?>
							<script>
								...
								*/
								$(document).ready(function(){
									$("#form-action").attr("action","<?php echo base_url()?>penjualan/combo_dp");
											
									$("#DP").bind("click",function(){
										
										if($("#DP").attr("checked") == true){
											$("#show_dp").removeAttr("style","display:none;");
											...
											$("#dp_code").html('DP.');
											$("#dp_code").html('DP.');
											console.log("combo_dp");
											}
											else{
												$("#show_dp").attr("style","display:none;");
												$("#cash").removeAttr("style","display:none;");
												$("#intdp").val('');
												$("#dp_name").val('');
												$("#is_dp").val(0);
												$("#dp_code").html('');
												console.log("combo_after");
												}
										});
/* 									
									$("#intdp").keyup(function(){
										sisa();
										if (!isNaN($('#intdp').val())) {
											...
											_dp = parseInt($('#intdp').val());
											$('#intcash').val(_dp);
											
											_bayar = parseInt(_dp);
											
											//console.log("_dp "+_dp+", _bayar "+_bayar);
											
											$('#intsisa').val(parseInt($("#totalbayar1").val()) + parseInt(_bayar));
											$('#intsisahidden').val(parseInt($("#totalbayar1").val()) + parseInt(_bayar));			
							...
							<!-- @param freemetal -->
								<tr>
									...
									<td colspan="2"  style='width:50%;'>Free Metal <input type="checkbox" id="chkBoxFreeMetal" />
                                        </td>
                                </tr>
								<script>
									$(document).ready(function(){
									
										$("#chkBoxFreeMetal").bind("click",function(){
										
											if($("#chkBoxFreeMetal").attr("checked") == true){
												
												$("#tracker002").val("free");
												console.log("chkBoxFreeMetal checked false");
												}
												else if($("#chkBoxFreeMetal").attr("checked") == false){
													
													$("#tracker002").val("bayar");
													
													console.log("chkBoxFreeMetal checked true");
													}
											});
											autoComp();
										});
...
<td width="63" rowspan="3"><div id="data">
                                  ...
                                  <td>&nbsp;
                                            ...
                                            <tr id="free_barang" style="display:none;"> <!-- freemetal -->
								...
								<tr id="show_dp" style="display:none;">
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td><span class='style1'>DP</span></td>
									<td>&nbsp;:</td>
									<td style='background:yellow'>Rp.<input type='text' name='intdp' id='intdp'   onkeyUp="return sisa();" onkeypress="return isNumberKey(event)" /></td>
                                </tr>                                
                                <tr id="debit">
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
...
<script type="text/javascript">
    ...
    function sisa()
    {
		...
		if($('#intdp').val() == ""){
            ...
            var intdp = parseInt($('#intdp').val());
        }
		
        var d = parseInt($('#totalbayar1').val());
        var t = a + b + c + intdp; //tambahan intdp
        var sisa = d - t;
		
		console.log('total: '+t);
		console.log('cash: '+t+'bayar : '+d);
		console.log('total sisa'+sisa);
...
//001
	...
	if($("#track6").val() == 0) {$("#metal_6").removeAttr("disabled");}
        ...
        if(($(".id1").val()=="") &&($(".frees").val()=="")){
			...
			var harga_asli = $('#harga_barang').val();
			promoada = 0;
            var out = '';
            out += 'Banyaknya<br>';
            ...
            else if($("#chkBox10").attr('checked') == true || $("#chktulip50_10").attr("checked") == true){ // else if($("#chkBox10").attr('checked') == true){
			...
			if($("#chkvoucher40").attr("checked") == true){
				promoada = 0.6;
				...
				console.log("promoada : ", promoada);
				console.log("voucherada : ", voucherada);
				
				harga = harga - (promoada * voucherada);
				pv	=	parseFloat(pv) - (promoada * parseFloat(voucherada/100000));
				autoComp();
				kali();
				}
				
			out += '<input id="promoada'+idx+'" name="barang['+idx+'][promoada]" type="hidden" size="5" value="'+promoada+'" readonly>';
			out += '<input id="voucherada'+idx+'" name="barang['+idx+'][voucherada]" type="hidden" size="5" value="'+voucherada+'" readonly>';
			out += '<input id="harga_asli_'+idx+'" name="barang['+idx+'][harga_asli]" type="hidden" size="5" value="'+harga_asli+'" readonly>';
			...
			//001
			ajaxgila(idx);
			$("#chkvoucher40").attr("checked",false);
...
//001
	...
	if($('#intid_jpenjualan').val() != 7) {
		...
		//fahmi
		/* else  if($('#intid_jpenjualan').val() == 16) {
		...
		if($('#chkV').attr('checked') == true && totalreg < 0)
		{
            ...
            var t = parseInt($('#intjumlah1hidden').val());
            var disc = 10;
    ...
    //check the checkbox
    $("#chkvochermetal").click(function(){
		if($("#chkvochermetal").attr('checked') == true){
				$("#chkvoucher40").attr("disabled",true);
				$("#chkvoucher40").attr("checked",false);
				vochermetal = 1;
				promoada = 0.6;
				voucherada = 50000;
				...
				$("#chkvoucher40").removeAttr("disabled");
				$("#chkvoucher40").attr("checked",false);
				vochermetal = 0;
				promoada = 0;
				voucherada = 0;
...
|______________________________________________________________________*/
	...
	*/
	function autoComp() {
		...
		//	alert("4");
			...
			autoCompMetal50();
		//	alert("4");
		}else if ($('#intid_jpenjualan').attr('value') == 1) {
			
			diskon40();
		}else if ($('#intid_jpenjualan').attr('value') == 16) {
	...
	*/
	$('#intid_jpenjualan').change(function(){
		...
		/* Fahmi Penjualan */
			var title = "Nota Penjualan Diskon 40";
			$('#title').text(title);
			$("#chkSmart").attr("checked",false);
			$("#chkSmart").attr("disabled","disabled");
			$("#chkBox10").attr("checked",false);
	...
	*/
	$('#chkSmart').click(function(){
		...
		{
			if ($('#intid_jpenjualan').attr('value') == 2 || $('#intid_jpenjualan').attr('value') == 3 || $('#intid_jpenjualan').attr('value') == 4 || $('#intid_jpenjualan').attr('value') == 5 || $('#intid_jpenjualan').attr('value') == 6 || $('#intid_jpenjualan').attr('value') == 7)
			{
				$("#chkBox10").attr("checked",false);
				$("#chkBox20").attr("checked",false);
				$("#chkBoxTrade").attr("checked",false);
...
/*
	...
	*/
	...
	//digunakan untuk diskon40
	
	var vochermetal = 0;
			
    function diskon40(){

                var ur = "<?php echo base_url(); ?>penjualan/lookupBarangDiskon40";
                $(".id1").autocomplete({
                    minLength: 5,
                    source:
                        function(req, add){
        		...
        		$(this).val() = q;
                    ...
                    select:
                        function(event, ui) {
						if($("#tracker002").val() == "free"){
							$("#result1").html("<input type='text' id='harga_barang_free' name='harga_barang_free' value='0' size='5' readonly='readonly'/><input type='hidden' id='id_free' name='id_free' value='" + ui.item.id + "' size='15' readonly /><input type='hidden' id='pv' name='pv' value='0' size='15' readonly='readonly'/><input type='hidden' id='id_harga' name='id_harga' value='0' size='15' />");
						}else{
