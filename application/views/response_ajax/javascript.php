...
//001
	...
	if($("#track6").val() == 0) {$("#metal_6").removeAttr("disabled");}
        ...
        if(($(".id1").val()=="") &&($(".frees").val()=="")){
            ...
            var out = '';
            out += 'Banyaknya<br>';
            if($("#chkBox20").attr('checked') == true || $("#chktulip20_20").attr("checked") == true){
            ...
            else if($("#chkBox10").attr('checked') == true || $("#chktulip50_10").attr("checked") == true||$("#chktulip30_10").attr("checked") == true||$("#chktulip30_10M").attr("checked") == true){ // else if($("#chkBox10").attr('checked') == true){
...
/* ikhlas5010 */
			if($("#chktulip50_10").attr("checked") == true){
				...
				/* promo voucher potongan 30% */
				var _vocherbaru = 0;
				var _pvvocher = 0;
				
				if($("#chkvocherbaru").attr("checked") == true){
					if ($('#id_wilayah').val() == 1){
							_vocherbaru = 50000 ;
							_pvvocher = 0.5;
				...
				if($("#chktulip30_10M").attr("checked") == true){ //diganti
					promoada = 0.7;				
					// harga = harga * 0.8;
					harga =  Math.ceil((harga - _vocherbaru) * 0.7);
					pv	=	((parseFloat(pv) - _pvvocher)  * 0.7).toFixed(2);
		...
		if($('.id1').val() != "" && $("#tracker002").val() == "free")
			{
				...
				if($("#chkBox10").attr('checked') == true || $("#chktulip50_10").attr("checked") == true||$("#chktulip30_10").attr("checked") == true||$("#chktulip30_10M").attr("checked") == true){
...
//sasaran fahmi
        }else if($("#chkBox10").attr('checked') == true || $("#chktulip30_10").attr('checked') == true || $("#chktulip30_10M").attr('checked') == true){
	...
	//brgsuka
	if ($('#chktulip30_10').attr('checked') == false || $('#chktulip30_10').attr('checked') == false|| $('#chktulip30_10M').attr('checked') == false){
    ...
    $("#chktulip30_10").click(function(){
      if ($('#chktulip30_10').attr('checked') == true){
		  $("#chktulip20_20").attr("disabled","disabled");
		  $("#chktulip30_10M").attr("disabled","disabled");
		   $('#brgsuka').removeAttr('disabled');
		   jbarang = 1;
		   autoComp();
	  }else{
		 /* $('#chktulip30_10M').removeAttr('disabled'); */
		 $('#chktulip20_20').removeAttr('disabled');
		 $("#brgsuka").attr("disabled","disabled");
	  }
    });
	$("#chktulip30_10M").click(function(){
      if ($('#chktulip30_10M').attr('checked') == true){
		  $("#chktulip20_20").attr("disabled","disabled");
		  $("#chktulip30_10").attr("disabled","disabled");
		  jbarang = 2;
		   $('#brgsuka').removeAttr('disabled');
...
|______________________________________________________________________*/
	...
	*/
	...
	/* fahmijenis */
		if ($('#intid_jpenjualan').attr('value') == 2) {
			...
			/* hut(); */
			if($("#chktulip30_10").attr("checked") == true || $("#chktulip30_10M").attr("checked") == true){ //tulip 50 komisi 10
		...
		/* fahmifree */
		 ...
		 else if ($("#chktulip30_10M").attr('checked') == true) {
			if ($("#tracker002").val() == "bayar")
			{
				autoCompPromoNormalMetal();
			} else if ($("#tracker002").val() == "free") {
				autoCompPromo20Free();
			}
		}
	...
	*/
	...
	/* diganti lagi ikhlas 2014 11 11  */
	...
	console.log('Metal');
		$(".id1").autocomplete({
                    ...
                    source:
                        function(req, add){
                        $.ajax({
                            url: "<?php echo base_url(); ?>promo2030/lookupBarangmetaltanggal",
                            dataType: 'json',
                            type: 'POST',
                            data:  {
                                term: req.term,
	...
	*/
	function kali_baru(id){
		...
		for (var i = 1; i <= parseInt($('#tracker001').val()); i++) {
		/* fahmitracker */
			if($("#chktulip50_10").attr("checked") == true||$("#chktulip30_10").attr("checked") == true||$("#chktulip30_10M").attr("checked") == true && status_free == 1){
				if (parseInt($('#total_'+ i).val()) >= 0 && parseInt($('#harga_'+ i).val()) >= 0 && parseFloat($('#pv_'+ i).val()) >= 0) {
					if (parseInt($('.sepuluh_'+ i).val()) > 0 && parseInt($('.status_free_'+ i).val()) == 1) {
		...
		if ((parseInt($('#tracker004').val()) > _totalQuantityFree + _totalQuantityFree20) && (status_free == 1) ) {
