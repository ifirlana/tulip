...
$(document).ready( function() {
	...
	<div id="page-bgtop">
		<div id="content">
        <div class="post">  <h2 class="title"> <?php if(isset($title)){echo $title; }else{?>Data PO Barang<?php }?></h2>
    ...
    <!-- ============isi ============ -->
		...
		?>
      	...
      	<tr class='data' align='center'>
            ...
            <td align='center'>&nbsp;<?php echo $m->no_po; ?></td>
            <td align='left'>&nbsp;<?php echo $m->waktu; ?></td>
            <td align='left'>&nbsp; <?php echo "<a href='get_PO/?no=".$m->no_po."' target='_blank'>";?>View  <?php echo "</a>";?></td>
            </tr>
		<?php endforeach; ?> 
    </tbody>
</table>
