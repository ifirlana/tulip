  ...
  <tr>
    	<td align="center">
		  ...
		  <td align="left">&nbsp;</td>
				...
				{
					$temp_1 = $row->total_undangan_nota+$row->total_undangan_nota_detail;
					$temp_2 = $row->undangan_nota+$row->undangan_nota_detail;
					if($temp_1 >0 or $temp_2 > 0)
					{
							 echo "<tr>
							  <td>".$row->datetgl."</td>
							  <td>".$row->intno_nota."</td>
							  <td>Lain-lain</td>
							  <td >".$row->strnama_dealer."</td>
							  <td >".$row->strnama_upline."</td>
							  <td >".$row->strnama_unit."</td>
							  <td >Undangan</td>
							  <td >".$temp_1."</td>
							  <td >0</td>
							  <td >0</td>
