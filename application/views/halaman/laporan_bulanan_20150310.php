...
header("Content-Disposition: attachment; filename=penjualan_bulanan".date("YmdHis").".xls");
...
<tr>
        ...
        <tr align="center" class="detail">
          <td colspan="2">Bulanan ( <?php echo $default[0]->datestart;?>  - <?php echo $default[0]->dateend;?>)</td>
          <td>&nbsp;</td>
        </tr>
    </table>    </td>
  <tr>
