...
header("Content-Disposition: attachment; filename=hutang_barang_mingguan.xls");
...
<table width="1069" align="center" >
	<tr class="detail2">
        ...
        <tr align="left" class="detail">
          <td colspan="4" class="detail2"><h2 class="title">REKAP HUTANG BARANG MINGGUAN <?php echo $cabang;?></h2></td>
          <td>&nbsp;</td>
        </tr>
        <tr align="left" class="detail">
