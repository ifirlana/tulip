...
<table width="1000" align="center" >
	<tr class="detail2">
        ...
        <table width="1000" align="center">
        <tr class="detail">
          <td width="776" rowspan="4" valign="top"><img src="<?php echo base_url();?>images/logo.jpg" />&nbsp;</td>
          <td width="147" class="detail2"><?php echo date('d-m-Y', strtotime($default[0]->datetgl))?></td>
     	  <td width="61"><a href="javascript:window.print()" onclick="location.href='../pusat';"><img src="<?php echo base_url();?>/images/print.jpg"/></a></td>
        </tr>
      <?php if(isset($surat_jalan)):?>
        ...
        <tr align="left">
            <td colspan="2" class="judul">No SPKB : <?php echo $default[0]->intid_po?>/ <?php echo $week[0]->intid_week;?>/SPKB/<?php echo date('Y')?></td>
          <td>&nbsp;</td>
        </tr>
        <?php endif;?>
    </table>
    ...
    <tr>
    	<td colspan="2" align="center">
        	<table width="925" border="1" align="center"class="detail">
              ...
              <th colspan="2">&nbsp;</th>
               ...
               <tr>
                ...
                <td align="center" class="detail"><?php echo $i++; ?></td>
                  ...
                  <td width="111" align="justify" class="detail"><?php echo $d->ket?></td>
                  <?php if(isset($surat_jalan)):?>
                  <td>
                  	<?php if($d->status==1):?>
