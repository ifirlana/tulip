...
header("Content-Disposition: attachment; filename=keluar_barang_mingguan.xls");
...
<table width="1069" align="center" >
	<tr class="detail2">
        ...
        <tr align="left" class="detail">
          <td colspan="4" class="detail2"><h2 class="title">REKAP PENGELUARAN BARANG MINGGUAN <?php echo $cabang;?></h2></td>
          <td>&nbsp;</td>
        </tr>
        <tr align="left" class="detail">
              ...
              <th rowspan="2" width="453">Nama Barang</th>
               ...
               <tr>
                ...
                <td align="center" class="detail"><?php echo $i++; ?></td>
				  ...
				  <td><?php if(isset($d->keterangan)){ echo $d->keterangan;}?></td>
              </tr>
                <?php 
