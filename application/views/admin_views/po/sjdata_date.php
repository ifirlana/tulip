...
<div id="page1">
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
              <div>	<h2 class="title"><?php if(isset($title)){ echo $title;}else{echo "Data Surat Jalan Dengan Tanggal";}?></h2>
                    <div class="entry">
                      <form action="<?php if(isset($url)){ echo $url;}else{echo base_url()."po/sjdata_date";}?>" method="post" name="frmjual" id="frmjual">
                            <div id="error"><?php echo validation_errors(); ?></div>
						<table width="685" boxrderrder="0" id="data" align="center">
                                 <tr>
                                  <td>Cabang</td>
                                  <td>&nbsp; <?php 
                                  ...
                                  <td>Tanggal awal</td>
                                  <td><input type="text" name="tanggalawal" id="demo3" size="6" /><a href="javascript:NewCssCal('demo3','yyyymmdd')"> <img src="<?php echo base_url();?>images/cal.gif" width="16" height="16" alt="Pick a date" /></a>
								  </td>
                                  <td>Tanggal akhir <input type="text" name="tanggalakhir" id="demo2" size="6" /><a href="javascript:NewCssCal('demo2','yyyymmdd')"> <img src="<?php echo base_url();?>images/cal.gif" width="16" height="16" alt="Pick a date" /></td>
