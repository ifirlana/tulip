...
<div id="page">
	...
	?>
          ...
          <tr>
            <td><input type="checkbox" name="pilih[]" value="<?php echo $m->intid_barang;?>_<?php echo $m->intid_po;?>_<?php echo $id_cabang;?>_<?php echo $m->qty;?>"/><input  name="no_spkb" type="hidden" size="10" value="<?php echo $m->no_spkb;?>"/></td>
