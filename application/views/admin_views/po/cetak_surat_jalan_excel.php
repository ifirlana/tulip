...
header("Content-Disposition: attachment; filename=Surat_jalan_excel.xls");
...
<table width="1000" align="center" >
	<tr class="detail2">
        ...
        <table width="1000" align="center" >
        <tr class="detail">
          <td width="728" colspan="3" rowspan="6" valign="top"><img src="<?php echo base_url();?>images/logo.jpg" />&nbsp;</td>
          <td width="195" class="detail2"><?php echo date('d-m-Y')?></td>
     	  <td width="61"><a href="javascript:window.print()" onclick="location.href='<?php echo base_url();?>po';"><img src="<?php echo base_url();?>/images/print.jpg"/></a></td>
        </tr>
        <tr class="detail">
