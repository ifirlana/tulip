...
<div id="page">
	<div id="page-bgtop">
        ...
        <div class="post">  <h2 class="title"> Surat Jalan</h2>
                         <div id="alert"></div>
                       <form action="<?php echo base_url()?>po/sjAdd" method="post" name="frmjual" id="frmjual">
   ...
   <form action="<?php echo base_url()?>po/buat_sj" method="post" name="myform" id="myform">  
    ...
    <tbody id="detail">
        ...
        <td><input type="checkbox" name="pilih[]" value="<?php echo $m->intid_po;?>" /></td>
        <td><?php echo $m->no_spkb; ?></td>
        <td><?php echo $m->strnama_cabang; ?><input type="hidden" name="intid_cabang" value="<?php echo $m->intid_cabang;?>"/></td>
        <td><a href='<?php echo base_url()."po/cetak_surat_keluar/".$m->intid_po;?>'>view</a></td>
        </tr>	
        <?php 
		$i++;
		endforeach; ?>				
