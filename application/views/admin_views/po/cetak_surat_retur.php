...
<table width="1000" align="center" >
	<tr class="detail2">
        ...
        <table width="1000" align="center">
        <tr class="detail">
          <td width="730" rowspan="4" valign="top"><img src="<?php echo base_url();?>images/logo.jpg" />&nbsp;</td>
          <td width="193" class="detail2"><?php echo date('d-m-Y', strtotime($default[0]->datetgl))?></td>
     	  <td width="61"><a href="javascript:window.print()" onclick="location.href='../sreturpusat';"><img src="<?php echo base_url();?>/images/print.jpg"/></a></td>
        </tr>
        <tr  class="detail">
        ...
        <tr align="left"  class="detail">
            <td colspan="2"  class="detail2">
                NO SRB: <?php echo $default[0]->no_srb?></td>
          <td>&nbsp;</td>
        </tr>
