...
$(document).ready( function() {
    ...
    function view_detailpo(id){
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>po/view_sttb/'+id,
            data: $(this).serialize(),
	...
	<div id="page-bgtop">
		<div id="content">
        <div class="post">  <h2 class="title"> Surat Tanda Terima Barang</h2>
         <p>Filter STTB</p>
<form action="<?php echo base_url()?>po/sttb" method="post">
    ...
    <!-- ============isi ============ -->
		...
		?>
      	...
      	<tr class='data' align='center'>
            ...
            <td align='center'>&nbsp;<?php echo $m->no_surat; ?></td>
            <td align='left'>&nbsp;<?php echo $m->datetgl; ?></td>
            <td align='left'>&nbsp; <?php echo "<a href='javascript:void(0)' onclick='view_detailpo(".$m->intid_sttb.")'\>";?>View
		 <?php echo "</a>"?></td>
            </tr>
		<?php endforeach; ?> 
    </tbody>
