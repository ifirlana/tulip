...
$(document).ready( function() {
	...
	<div id="page-bgtop">
        ...
        <div class="post">  <h2 class="title"> SURAT RETUR BARANG</h2>
          <p>Filter SRB</p>
<form action="<?php echo base_url()?>po/returpusat" method="post">
    ...
    <!-- ============isi ============ -->
		...
		?>
      	...
      	<tr class='data' align='center'>
            ...
            <td align='center'>&nbsp;<?php echo "<a href='javascript:void(0)' onclick='view_detailretur(".$m->intid_retur.")'\>";?><?php echo $m->no_srb; ?><?php echo "</a>";?></td>
            <td align='left'>&nbsp;<?php echo $m->datetgl; ?></td>
            <td align='left'>&nbsp; <?php echo "<a href='cetak_surat_retur/$m->intid_retur' target='_blank'>";?>View  <?php echo "</a>";?>| 
		 	<?php echo "<a href='cetak_sttb/$m->intid_retur' target='_blank'>"?>
         	Next
		 	<?php echo "</a>"?></td>
            </tr>
		<?php endforeach; ?> 
