    ...
    $('#addBrg').bind('click', function(e){
        ...
        if($(".id1").val()==""){
           ...
           out += 'Nama Barang &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Banyak&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
            ...
            out += '<input name="barang[][intid_barang]" type="text" size="30" value="'+brg+'"  />';
            
            out += '<input name="barang[][intid_id]" type="hidden" value="'+id_barang+'">&nbsp;';
			out += '<input id="'+idx+'" class="semua_'+idx+'" name="barang[][intquantity]" type="text" size="5" value="0" onkeyUp="remove(this.id)"/>&nbsp;';
			out += '<input name="barang[][ket]" type="text" size="30" />';   
			out += '<input name="barang[][stok]" type="text" size="5" value="'+stok+'" readonly="readonly"/>';      
