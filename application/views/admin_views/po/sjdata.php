            ...
            <div id="content">
              <div>	<h2 class="title"><?php if(isset($title)){ echo $title;}else{echo "Data Surat Jalan";}?></h2>
					...
					<?php 
						...
						{
							echo "<div><p style='margin-right:0;'><small><a href='".base_url()."po/sjdata_date'>Pencarian Tanggal</a></small></p></div>";
						}
					?>
                      <form action="<?php if(isset($url)){ echo $url;}else{echo base_url()."po/sjdata";}?>" method="post" name="frmjual" id="frmjual">
