...
<div id="page">
	<div id="page-bgtop">
		<div id="content">
        <div class="post">  <h2 class="title"> Surat Jalan Retur Barang</h2>
                         <div id="alert"></div>
                       <form action="<?php echo base_url()?>po/sjAdd_RSP" method="post" name="frmjual" id="frmjual">
   ...
   <form action="<?php echo base_url()?>po/buat_sj_sparepart" method="post" name="myform" id="myform">  
    ...
    <tbody id="detail">
        ...
        <td><input type="checkbox" name="pilih[]" value="<?php echo $m->intid_retur_sparepart;?>" /></td>
        <td><?php echo $m->no_srsp; ?></td>
