...
<div id="page">
	<div id="page-bgtop">
		<div id="content">
        <div class="post">  <h2 class="title"> Buat Surat Jalan Retur Barang</h2>
        <div id="alert"></div>
    <form name="myform" id="myform" action="<?php echo base_url()?>po/save_sjpo_sparepart" method="post">
      <table width="685" border="0" id="data" align="center">
          <tr>
            <td>CAB/SC</td>
            <td><?php echo $cabang;?><input type="hidden" name="intid_cabang" value="<?php echo $id_cabang;?>" /><input type="hidden" name="no_srsp" value="0" /></td>
            <td>&nbsp;</td>
            <td>Bandung,</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td colspan="2">NO. SJRB : <?php echo $maxId?>/
            <?php echo $week[0]->intid_week;?>/SJPR/<?php echo date('m')?>/
            <?php echo date('Y')?>
            <input type="hidden" name="no_sj" value="<?php echo $maxId."/".$week[0]->intid_week."/SJPR/".date('m')."/".date('Y')?>" />            </td>
            <td width="11">&nbsp;</td>
	...
	?>
          ...
          <tr>
            <td><input type="checkbox" name="pilih[]" value="<?php echo $m->intid_barang;?>_<?php echo $m->intid_retur_sparepart;?>_<?php echo $id_cabang;?>_<?php echo $m->qty;?>"/><input  name="no_srsp" type="hidden" size="10" value="<?php echo $m->no_srsp;?>"/></td>
            <td><input type="text" name="namabarang" size="50"  value="<?php echo $m->strnama;?>" readonly="readonly"/></td>
            <td><input name="qty" type="text" size="2" value="<?php  echo $m->qty;?>" readonly="readonly"/></td>
            <td><input name="quantity[]"  type="text" size="2" /></td>
            <td><textarea name="textarea" cols="10" rows="1" readonly="readonly"><?php echo $m->ket;?></textarea></td>
          </tr>
