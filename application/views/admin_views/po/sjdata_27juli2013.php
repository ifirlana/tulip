        ...
        <div id="page-bgtop">
            <div id="content">
              <div>	<h2 class="title">Surat Jalan</h2>
                    <div class="entry">
                      <form action="<?php echo base_url()?>po/sjdata" method="post" name="frmjual" id="frmjual">
						...
						<table width="685" border="0" id="data" align="center">
                                 <tr>
								  ...
								  ?><input type="text" name="intid_cabang" id="intid_cabang" size="20" />
                                  <?php
								  }else{
								  ?>
									<input type='text' id='id_cabang' name='nama_cabang' value='<?php echo $cabang;?>'  disabled />
									<input type='hidden' id='id_cabang' name='id_cabang' value='<?php echo $id_cabang;?>' size='30' />
								  <?}?>
    ...
    <td width="677">&nbsp;
		...
		?>         
           <tr class='data' align='center'>
            ...
            <td align='left'>&nbsp;<?php echo $m->week; ?></td>
            <td align='center'>&nbsp;<?php echo $m->no_sj; ?></td>
            <td align='left'>&nbsp;<?php echo $m->tgl_kirim; ?></td>
            <td align='center'>&nbsp; <?php echo "<a href='".base_url()."POCO/GET_SJ/?no_sj=".$m->no_sj."&no_spkb=".$m->no_spkb."' target='_blank'>";?>View<?php echo "</a>";?></td>
          </tr>
          <?php endforeach;?>
			<?php 
			foreach($default2 as $m) : 
		...
		?>         
           <tr class='data' align='center'>
            ...
            <td align='center'>&nbsp;<?php echo $m->no_sj; ?></td>
            <td align='left'>&nbsp;<?php echo $m->tgl_kirim; ?></td>
            <td align='center'>&nbsp; <?php echo "<a href='".base_url()."POCO/GET_SJ2/?no_sj=".$m->no_sj."&no_sttb=".$m->no_sttb."' target='_blank'>";?>View<?php echo "</a>";?></td>
          </tr>
          <?php endforeach;?>
