...
$(document).ready( function() {
	...
	<div id="page-bgtop">
		<div id="content">
        <div class="post">  <h2 class="title"> SURAT RETUR SPAREPART[Cabang-Week]</h2>
          <p>Filter SRSP</p>
<form action="<?php echo base_url()?>po/sreturpusat_rejec_adi" method="post">
	<table width="90%" border="0" cellpadding="1" cellspacing="1" id="data" align="center">
    	<tr class="table">
        	<td>Nama Cabang : <input type="text" name="cari" /></td>
        	<td>Week : <input type="text" name="cariWeek" size="5" /></td>
        	<td>Tahun : <input type="text" name="cariTahun" size="5"  /></td>
    ...
    <!-- ============isi ============ -->
		...
		?>
      	...
      	<tr class='data' align='center'>
            ...
            <td align='left'>&nbsp; <?php echo "<a href='".base_url()."po/cetak_surat_retur_sparepart/$m->intid_retur_sparepart' target='_blank'>";?>View  <?php echo "</a>";?></td>
            </tr>
		<?php endforeach; ?> 
    </tbody>
</table>
