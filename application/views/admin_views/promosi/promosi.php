...
<div id="wrapper">
	...
	<div id="page-bgtop">
		<div id="content">
        <div class="post">  <h2 class="title"> Promosi 10%</h2>
 <table width="95%" border="0" cellpadding="0" cellspacing="0" id="data" align="center">
<tr>
<?php echo "<td  align='left' style='width:75%' ><img  src='".base_url()."images/img10.png' align='absmiddle'/>".anchor('promosi/add', 'Tambah Promosi')."</td>";?>
</tr>
</table>

<form method="post" action="<?php echo base_url(); ?>promosi/index">
  ...
  <td width="390"><input type="text" name="nama" size="50" autocomplete="off" /></td></tr>
    ...
    <thead>
        <tr  align="center"  class="table">
           <th width="43">No</th>
            <th width="90">Week Start</th>
            <th width="82">Week End</th>
            <th width="326">Nama Barang</th>
			<th width="252">Free Barang</th>
			<th>Aksi</th>
        </tr>
    </thead>
    <tbody>
    ...
    <!-- ============isi ============ -->
		...
		<?php 
			$i=1;
			//foreach($promo as $m) : 
			if(count($nama_promo10->result_array())>0)
		    {
	        foreach($nama_promo10->result_array() as $nd)
	        {
		?>
      	...
      	<tr class='data' align='center'>
            ...
            <td align="center" width="109"><?php echo anchor ('promosi/edit/'.$nd['intid_promo'], 'Edit'); ?>| <?php echo anchor ('promosi/delete/'.$nd['intid_promo'], 'Hapus', array('onClick' =>"return confirm ('Apakah Anda yakin akan menghapus data ')")); ?></td>
        </tr>
		<?php }
	    }
	    else
	    {
	        echo '<tr><td>Tidak ditemukan Barang Promo 10 dengan nama <b>"'.$nama.'"</b></td></tr>';
	    }//endforeach; ?> 
    </tbody>
</table>
            <table width="90%" border="0" cellpadding="1" cellspacing="1" id="data" align="center">
