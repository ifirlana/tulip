...
<div id="page">
    ...
    <table border="0" cellpadding="1" cellspacing="1" align="center" width="100%">
      <tr align="center">
        <td colspan="2">Edit Data Promosi </td>
      </tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td><select name="intid_week_end">
          ...
          <?php
				...
				{
					if($intid_week_end==$idw[$i]){ $style="selected"; }else{ $style=""; }
      ...
      <tr>
        ...
        <td><input type="text" name="intid_barang_free"  id="intid_barang_free" size="50" value="<?php echo $nama; ?>" /><div id="result2"></div></td>
            ...
            <th></th>
            <td><input type="submit" value="Edit" class="button"/>&nbsp;<input class="button" type="button" value="Cancel" onclick="location.href='<?php echo base_url()?>promosi';"/></td>
        </tr>
 </table>
