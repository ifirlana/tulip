...
<div id="page">
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
    <form action="<?php echo base_url()?>barang/addhadiah" method="post">
      ...
      <tr>
       ...
       <tr>
            ...
            <td><input type="submit" value="Save" class="button"/>&nbsp;
              <input class="button" type="button" value="Cancel" onclick="location.href='<?php echo base_url()?>barang/baranghadiah';"/></td>
        </tr>
 </table>
