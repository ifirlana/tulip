...
<td width="63" rowspan="3"><div id="data">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>Omset 15%<br />Omset 20%<br />Total Omset</td>
                                    <td>:<br />:<br />:</td>
                                    <td>
                                        Rp.<input type="hidden" name="jml10" /><input type="text" name="jml15" id="intjumlah1" readonly="readonly"/><br />
                                        ...
                                        <input type="hidden" name="jml15" id="intjumlah1hidden"/>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        Rp.<input type="text" name="komisi15" id="komisi1" readonly="readonly"/>
                                        <input type="hidden" name="komisi15hidden" id="komisi1hidden"/><input type="hidden" name="komisi1" readonly="readonly"/>
                                        <input type="hidden" name="komisi1hidden"/>                                    </td>
                                </tr>
	...
	*/
	function kali_baru(id){
		...
		if ($('#intid_jpenjualan').attr('value') == 4)
		{
			...
			$('#intpv').val(_temppv);
			$('#komisi1').val(parseInt($('#intjumlah').val()) * 0.15);//komisi15
		...
		if ($('#intid_jpenjualan').attr('value') == 6)
		{
			...
			$('#intpv').val((parseInt($('#intjumlah').val()) / 100000).toFixed(2));
			$('#komisi1').val(parseInt($('#intjumlah').val()) * 0.15);
			$('#totalbayar').val(parseInt($('#intjumlah').val()) - parseInt($('#komisi1').val()));
		...
		if ($("#chkV").attr('checked') == true)
		{
			...
			{
				$('#komisi1').val(parseInt($('#komisi1').val()) - (_voucher * 0.15));
			} else {
	...
	*/
    ...
    function diskon20(){
        	...
        	if ($("#tracker002").val() == "bayar")
        	{
                ...
                var ur = "<?php echo base_url(); ?>penjualan/lookupBarangDiskon20";
                $(".id1").autocomplete({
                    minLength: 5,
                    source:
                        function(req, add){
