...
<div id="wrapper">
    ...
    <script type="text/javascript">
            ...
            $(document).ready( function() {
				...
				$("#strnama_dealer").autocomplete({
                    ...
                    select:
                        function(event, ui) {
                        $("#result1").html(
                        "<input type='hidden' align='top' id='strkode_dealer' name='strkode_dealer' value='" + ui.item.id + "'/><input type='hidden' align='top' id='intid_dealer' name='intid_dealer' value='" + ui.item.intid_dealer + "'/><input type='hidden' align='top' id='stremail' name='stremail' value='" + ui.item.stremail + "'/><input type='hidden' align='top' id='strhp' name='strhp' value='" + ui.item.strhp + "'/>"
                    );
		...
		$("#formSubmit").bind("click",function(){
			...
			$.ajax({
		        		url: "<?php echo base_url(); ?>website/getDataResetMember",
		          		type: 'POST',
		          		data: {
	...
	<div id="page-bgtop">
        ...
        <div class="post">
          <fieldset>
		<legend><strong>Hard Reset</strong></legend>
