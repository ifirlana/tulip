...
////////////////////////////////////////////////////////
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">promo diskon 50% - komisi 10%</h2>
                    <div class="entry">
...
|______________________________________________________________________*/
	...
	*/
	function autoComp() {
		...
		//	alert("4");
			...
			diskon50();
		}else if ($('#intid_jpenjualan').attr('value') == 18) {
			
			diskon50();
		} 
		else {
			console.log("value : "+$('#intid_jpenjualan').val());
			diskon50();
		}
		if ($("#chkBox20").attr('checked') == true) {
	...
	*/
	$('#intid_jpenjualan').change(function(){
		...
		/* Fahmi Penjualan */
			var title = "Nota Penjualan Diskon 50";
			$('#title').text(title);
			$("#chkSmart").attr("checked",false);
			$("#chkSmart").attr("disabled","disabled");
			$("#chkBox10").attr("checked",false);
	...
	*/
	function kali_baru(id){
		...
		$('#totalbayar').val(/* parseFloat */parseFloat($('#intjumlah').val()));
	...
	*/
    ...
    function diskon50(){
        	...
        	if ($("#tracker002").val() == "bayar")
        	{
                ...
                var ur = "<?php echo base_url(); ?>penjualan/lookupBarangDiskon50";
                $(".id1").autocomplete({
                    minLength: 5,
                    source:
                        function(req, add){
