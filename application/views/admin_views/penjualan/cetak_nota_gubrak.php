	...
	<tr class="detail2">
        ...
        <tr class="detail">
          ...
          <td width="203"> <?php echo $default[0]->strnama_cabang?>, <?php echo date('d-m-Y', strtotime($default[0]->datetgl))?></td>
     	  <td width="41"><a href="javascript:window.print()" onclick="location.href='nota';"><img src="<?php echo base_url();?>/images/print.jpg"/></a></td>
        </tr>
        <tr class="detail">
    	...
    	<td colspan="2" align="center">
			...
			<tr class="detail2">
              ...
              <th width="171">Jumlah</th>
                ...
                <tr>
                	<td colspan="3" align="right" class="detail2" id='style-css'>&nbsp;Jumlah &nbsp;&nbsp;&nbsp;</td>
...
<td colspan="2" align="center">
               ...
               <tr class="detail2">
                 ...
                 <td width="173" align="justify"  class='style-css'><?php echo "Rp. ".number_format($default[0]->intvoucher,2 , ',' , '.')?></td>
                </tr>
               <tr class="detail2">
               <td>&nbsp;</td>
