						...
						<input type="hidden" name="halaman"  value="lunas">
                            ...
                            <table width="685" border="0" id="data" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;
											<input type="hidden" name="intid_jpenjualan" value="" id="post_intid_jpenjualan">
...
//001
	...
	if($('#intid_jpenjualan').val() != 7) {
        ...
        if($('#komisi1hidden').val() == ""){
            ...
            var kom1 = parseFloat($('#komisi1hidden').val());
        }
        if($('#komisi2hidden').val() == ""){
            var kom2 = 0;
        }else{
            var kom2 = parseFloat($('#komisi2hidden').val());
        }
...
|______________________________________________________________________*/
	...
	*/
	function autoComp() {
		...
		if ($('#intid_jpenjualan').attr('value') == 3) {
			if(window.is_ng == 1){
				autoCompPromoNormal();
			}else 
			{
				alert('Maaf Dealer Tersebut Belum Terdaftar !');
				location.reload();
			}
	...
	*/
	function kali_baru(id){
		...
		if ((parseFloat($('#tracker004').val()) > _totalQuantityFree + _totalQuantityFree20)) {
		...
		$('#intjumlah1').val(new Intl.NumberFormat(['ban', 'id']).format($('#intjumlah1').val()));
		$('#intjumlah2').val(new Intl.NumberFormat(['ban', 'id']).format($('#intjumlah2').val()));
		$('#intjumlah').val(new Intl.NumberFormat(['ban', 'id']).format($('#intjumlah').val()));
		$('#komisi1').val(new Intl.NumberFormat(['ban', 'id']).format($('#komisi1').val()));
		$('#komisi2').val(new Intl.NumberFormat(['ban', 'id']).format($('#komisi2').val()));
		$('#charge3').val(new Intl.NumberFormat(['ban', 'id']).format($('#charge3').val()));
		$('#totalbayar').val(new Intl.NumberFormat(['ban', 'id']).format($('#totalbayar').val())); */
		//format smua angka as rupiah
		$('#intjumlah1').val(formatAsRupiah(parseFloat($('#intjumlah1').val())));
		$('#intjumlah2').val(formatAsRupiah(parseFloat($('#intjumlah2').val())));
		$('#intjumlah').val(formatAsRupiah(parseFloat($('#intjumlah').val())));
		$('#komisi1').val(formatAsRupiah(parseFloat($('#komisi1').val())));
		$('#komisi2').val(formatAsRupiah(parseFloat($('#komisi2').val())));
		$('#charge3').val(formatAsRupiah(parseFloat($('#charge3').val())));
		$('#totalbayar').val(formatAsRupiah(parseFloat($('#totalbayar').val())));
	...
	*/
	function formatAsRupiah(amount){
        	...
        	return amount/*  (amount_array.join(",")) */;
    	}
