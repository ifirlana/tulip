...
//line ikhlas 25042013
            function autoCompPromo10(){
				...
				//free ny dibuka menjadi barang biasa. kalau mau dibalikin tinggal ganti barang
				//var urlfree = "<?php echo base_url(); ?>penjualan/lookupBarangFree10";
				var urlfree = "<?php echo base_url(); ?>penjualan/lookupBarang";
...
////////////////////////////////////////////////////////
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">penjualan dp</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>penjualan/dp" method="post" name="frmjual" id="frmjual">
                            ...
                            <table width="685" border="0" id="data" align="center">
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="chkBoxTulip30" id="chkBoxTulip30" disabled="disabled"/>
                                        <input type="checkbox" name="chkVTulip30" id="chkVTulip30" disabled="disabled"/>Voucher Tulip 30%
                                        </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
...
<td width="63" rowspan="3"><div id="data">
                                ...
                                <tr>
                                  ...
                                  <td>&nbsp;:</td>
                                    <td>Rp.<input type="text" name="intdp" id="intdp"  onkeyUp="return sisa();" onkeypress="return isNumberKey(event)" /></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
...
//001
	...
	if($("#track6").val() == 0) {$("#metal_6").removeAttr("disabled");}
        ...
        if(($(".id1").val()=="") &&($(".frees").val()=="")){
            ...
            if($("#chkBox20").attr('checked') == true){
			...
			else if($("#chkBoxTulip30").attr('checked') == true ){ //ifirlana@gmail.com 2014 10 16
				is_diskon = 0.7;
				if($("#chkVTulip30").attr('checked') == true){
				
					if ($('#id_wilayah').val() == 1){
					
						intvoucher = 50000;
						vo = intvoucher * is_diskon;
						} else {
							intvoucher = 60000;
							vo = intvoucher * is_diskon;
							}
				...
				harga = (harga * is_diskon) - vo;
				pv = pv * is_diskon - (vo / 100000);
				total = jumlah * harga;
				
				$("#chkVTulip30").attr('checked',false);
           ...
           /* if($("#chkBoxTrade").attr('checked') == true){
            ...
            out += '<input type="hidden" name="barang['+idx+'][is_diskon]" size="2" value="'+is_diskon+'" readonly/>';
            out += '<input type="hidden" name="barang['+idx+'][intnormal]" size="2" value="'+intnormal+'" readonly/>';
            out += '<input type="hidden" name="barang['+idx+'][intvoucher]" size="2" value="'+intvoucher+'" readonly/>';
    ...
    function kali_sepuluh(id){
        ...
        if($("#chkBoxFree").attr('checked') == true){
			...
			if($("#freeonefree").val()==''){
				...
				var jf1f = jf + parseInt($("#freeonefree").val());
			}
			
			/*$('#freeonefree').val(jf1f); 
...
//001
	if($("#intid_jpenjualan").val() == 13 && $(".semua_" + id).val() > 1)
	{
        ...
        }else if($("#chkBoxTulip30").attr('checked') == true){
	...
	function satufreesatuLaunch(){
		...
		console.log("satufreesatuLaunch start");
		...
		var ur = "<?php echo base_url(); ?>penjualan/lookupBarangSatuFreeSatuBayarLaunching";
        		...
        		$(this).val() = q;
					...
					console.log("satufreesatuLaunch select");
                    },
                });
				
				console.log("satufreesatuLaunch free");
		...
		console.log("satufreesatuLaunch ending");
		}
    ...
    $('#intid_jpenjualan').change(function()
    {
        if ($(this).attr('value')== 1)
        {
			...
			$("#chkV").attr("disabled","");
			<!-- ifirlana 2014 10 16-->
			$("#chkBoxTulip30").attr("disabled","");
			$("#chkVTulip30").attr("disabled","");
        ...
        } else  if ($(this).attr('value')== 5)
        {
			...
			satufreesatuLaunch(); console.log("satufreesatuLaunch load");
