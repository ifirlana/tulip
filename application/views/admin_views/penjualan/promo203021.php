...
|______________________________________________________________________*/
	...
	*/
	...
	/* fahmijenis */
		...
		/* fahmifree */
		 else if (/* $("#chktulip30_10").attr('checked') == true ||  */$("#chktulip20_10").attr('checked') == true) {
			/* if ($("#tracker002").val() == "bayar")
			{
				autoCompPromoNormal();
			} else */ if ($("#tracker002").val() == "free" ) {
	...
	*/
	function kali_baru(id){
		...
		for (var i = 1; i <= parseInt($('#tracker001').val()); i++) {
		/* fahmitracker */
			if($("#chktulip50_10").attr("checked") == true||$("#chktulip30_10").attr("checked") == true||$("#chktulip20_10").attr("checked") == true /* && status_free == 1 */){
				if (parseInt($('#total_'+ i).val()) >= 0 && parseInt($('#harga_'+ i).val()) >= 0 && parseFloat($('#pv_'+ i).val()) >= 0) {
		...
		if ((parseInt($('#tracker004').val()) > _totalQuantityFree + _totalQuantityFree20) && ($("#chktulip20_10").attr("checked") == true) ) {
			//if( $("#chktulip50_10").attr("checked") != true){ //not working
