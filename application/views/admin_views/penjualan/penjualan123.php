...
<div id="wrapper">
	...
	<div id="page-bgtop">
      ...
      <tr>
        <td>&nbsp;Nama </td>
        <td id="error"><input type="text" name="strnama_dealer" id="strnama_dealer_cek" size="30" >
			<script>
				$(this).ready( function() 
				{
					$("#strnama_dealer_cek").autocomplete(
					{
						minLength: 2,
						source: 
						function(req, add){
							$.ajax({
								url: "<?php echo base_url(); ?>penjualan/lookupNamaUser",
								dataType: 'json',
								type: 'POST',
								data: req,
								success:    
          ...
          <img  src="<?php echo base_url()?>images/asterix3.jpg" align="absmiddle" title="Asterix"/><div id="message"></div></td>
      </tr>
      <tr>
        <td>&nbsp;No. KTP</td>
