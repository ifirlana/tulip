...
<div id="page1">
    <div id="wrapper">
        ...
        <script type="text/javascript">
			...
			$('#cekomset').click(function() {
				...
				$.ajax({					
					url: "<?php echo base_url(); ?>penjualan/check_omset_lain_new",
					type: 'POST',
					async : false,
					data: form_data,
					success:
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">penjualan WAFFLE PAN SPECIAL SURPRISE</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>penjualan/lglain1" method="post" name="frmjual" id="frmjual">
				...
				<input type="hidden" name="barang[1][nomor_nota]" size="20" value="<?php echo $max_id?>" readonly/>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td><input type="button" name="button" id="cekomset" value="Cek Omset" /><input type="hidden" name="is_lgBaru" value="1"/> </td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                </tr>
