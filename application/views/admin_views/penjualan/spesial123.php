...
<div id="page1">
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">Penjualan Spesial 123</h2>
                    <div class="entry">
                            ...
                            <table width="685" border="0" id="data" align="center">
                                ...
                                <tr>
									...
									?>
										...
										<div id='formBeToBe' style='display:none;'>
											<label><input type='checkbox' id='betobe' class='betobe' >Voucher Be To Be</label>
										</div>
										</td>
									<td></td>
                              </tr>
	...
	*/
	$('#intid_jpenjualan').change(function() {
		...
		if ($(this).attr('value')== 14)
		{
            ...
            $("#formBeToBe").removeAttr('style','style');
