...
////////////////////////////////////////////////////////
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">penjualan be to be</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>penjualan/notabetobe" method="post" name="frmjual" id="frmjual">
						<input type="hidden" name="halaman"  value="betobe">
						<input type="hidden" name="chkadabapak"  id="chkadabapak" value="0">
...
//001
	...
	//check betobe
	$("#chktulipbetobe").click(function(){
		if($('#strkode_dealer').val() == 'M770640'){
						$('#chkadabapak').val('1');
