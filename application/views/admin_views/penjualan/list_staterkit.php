<div class="post">	
		...
		<table width='100%'>
            ...
            <tr>
            	<td>&nbsp;</td>
                <td align="left">Kartu Kredit</td>
                <td>:</td>
                <td><input type="text" name="intkkredit" id="intkkredit" onchange="return sisa();" style='100%'/></td>
            </tr>
            <tr>
            	<td>&nbsp;</td>
                <td align="left">Sisa</td>
                <td>:</td>
                <td><input type="text" name="intsisa" id="intsisa" style='100%' /></td>
            </tr>
            <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
