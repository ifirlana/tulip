    ...
    <div id="wrapper">
		...
		function promo50(ID,num,id_cabang,track){
			...
			$("#metal_6").attr("disabled","disabled");
                        $("#result001").empty();
                        $("#result001").append(
                        	"<input type='text' align='top' id='strkode_dealer' name='strkode_dealer' value='" + ui.item.id + "' readonly/><br><td><input type='text' id='strkode_upline' name='strkode_upline' value='" + ui.item.value2 + "' size='30' readonly/><input type='hidden' size='2' id='pengejaranChall' value='"+ui.item.challhut+"' readonly><input type='hidden' size='2' id='pengejaranPromo' value='"+ui.item.promo+"' readonly></td>"
			);			
...
////////////////////////////////////////////////////////
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">penjualan diskon 20% komisi 15% New</h2>
                    <div class="entry">
							  ...
							  */
                              ...
                              <tr id="showattrlainlain3">
								...
								<tr id="showattrlainlain3">
									...
									<td ><input type="checkbox" name="chktulip20_15" id="chktulip20_15"  />
                                    </td>
                                </tr>
                                <tr>
		...
		//	alert("4");
			...
			if($("#chktulip50_10").attr("checked") == true){ //tulip 50 komisi 10
				...
				autoCompPromo50();//config
					...
					if(($('#intid_jpenjualan').attr('value') == 1)&& ($("#pengejaranPromo").val()==1)){
						autoCompPromoD20K15();//config
					}else if(($('#intid_jpenjualan').attr('value') == 1)&& ($("#pengejaranPromo").val() != 1)){
						alert("Mohon Maaf Dealer "+$("#strnama_dealer").val()+" \n Belum Memenuhi Syarat !!!");
						$("#chktulip20_15").attr("checked",false);
					}
					else{
						autoCompPromoD20K15();//config
					}
