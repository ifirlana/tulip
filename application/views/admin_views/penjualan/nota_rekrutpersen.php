...
<div id="page1">
    <div id="wrapper">
        ...
        <script type="text/javascript">
			...
			$('#cekomset').click(function() {
				...
				$.ajax({					
					url: "<?php echo base_url(); ?>penjualan/check_omset_lain_new_1",
					type: 'POST',
					async : false,
					data: form_data,
					beforeSend:
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">Penjualan Tebus Rekrut</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>penjualan/rekrutpersen" method="post" name="frmjual" id="frmjual">
                            ...
                            <table width="685" border="0" id="data" align="center">
                                ...
                                <tr>
                                    ...
                                    <td><input type="button" name="button" id="cekomset" value="Cek Rekrut" />
											<input type="hidden" name="is_lgBaru" value="1"/> </td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                </tr>
