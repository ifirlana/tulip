...
<div class="page">
	<div class="header">
		...
		<div style="margin-left:30px;margin-right:100px;">
			<span>
				...
				?>
				Nota&nbsp Pembayaran&nbsp <?php echo $judul;?><br/>
				Cicilan ke-
                 <?php 
				if($default[0]->c1==1&&$default[0]->c2==1&&$default[0]->c3==1&&$default[0]->c4==1&&$default[0]->c5==1&&$default[0]>c6==1&&$default[0]->c7==1){
				$cicilan="7";
				}else if($default[0]->c1==1&&$default[0]->c2==1&&$default[0]->c3==1&&$default[0]->c4==1&&$default[0]->c5==1&&$default[0]->c6==1){
				$cicilan="6";
				}else if($default[0]->c1==1&&$default[0]->c2==1&&$default[0]->c3==1&&$default[0]->c4==1&&$default[0]->c5==1){
				$cicilan="5";
				}else if($default[0]->c1==1&&$default[0]->c2==1&&$default[0]->c3==1&&$default[0]->c4==1){
				$cicilan="4";
				}else if($default[0]->c1==1&&$default[0]->c2==1&&$default[0]->c3==1){
				$cicilan="3";
				}else if($default[0]->c1==1&&$default[0]->c2==1) {
				$cicilan="2";
				}else if($default[0]->c1==1){ 
				$cicilan="1";
				} else {
				$cicilan="0";
				}
	...
	<div class="content" style="margin-left:10px;margin-top:30px;">
		...
		<div class="block">
			<div>Cicilan</div>
			<div class="bayar"><?php $cicil = ($cicilan*$default[0]->qty); echo "Rp. ".number_format($cicil,2 , ',' , '.')?></div>
		</div>
		<div class="block">
			<div>Komisi 20%</div>
		...
		<div class="block highlight">
			<div>Cash</div>
			<div class="bayar"><?php $cash = $cicil - $default[0]->intkomisi20 - $default[0]->intkomisi10; echo "Rp. ".number_format($cash,2 , ',' , '.')?></div>
		</div>
		<div class="block">
			<div>Debit</div>
...
<table width="800" align="center" class="detail">
	<tr class="detail2">
        ...
        <tr>
            <td align="justify"><h3> Nama&nbsp;&nbsp;: <?php echo $default[0]->strnama_dealer?></h3></td>
            <td width="41">&nbsp;</td>
        </tr>
        <tr>
            <td><h3> Upline&nbsp;&nbsp;: <?php echo $default[0]->strnama_upline?></h3></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td> <h3>Unit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $default[0]->strnama_unit?></h3> </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td colspan="2" class="detail">
              <h3>  NOTA  NO. : <?php echo $no_nota;?>     </h3>   	</td>
                <td>&nbsp;</td>
        </tr>
        <tr align="center">
			...
			<h3>
				...
				?>
                 Nota Pembayaran <?php echo $judul;?><br />
                 Cicilan ke-
                 <?php 
					if($default[0]->c1!=0&&$default[0]->c2!=0&&$default[0]->c3!=0&&$default[0]->c4!=0&&$default[0]->c5!=0&&$default[0]->c6!=0&&$default[0]->c7!=0){
					$cicilan="7";
					}else if($default[0]->c1!=0&&$default[0]->c2!=0&&$default[0]->c3!=0&&$default[0]->c4!=0&&$default[0]->c5!=0&&$default[0]->c6!=0){
					$cicilan="6";
					}else if($default[0]->c1!=0&&$default[0]->c2!=0&&$default[0]->c3!=0&&$default[0]->c4!=0&&$default[0]->c5!=0){
					$cicilan="5";
					}else if($default[0]->c1!=0&&$default[0]->c2!=0&&$default[0]->c3!=0&&$default[0]->c4!=0){
					$cicilan="4";
					}else if($default[0]->c1!=0&&$default[0]->c2!=0&&$default[0]->c3!=0){
					$cicilan="3";
					}else if($default[0]->c1!=0&&$default[0]->c2!=0) {
					$cicilan="2";
					}else if($default[0]->c1!=0){ 
					$cicilan="1";
					} else {
					$cicilan="0";
					}
    	...
    	<td colspan="2" align="center">
			...
			<tr class="detail2">
                ...
                <tr>
                    ...
                    <td align="left"  class='style-css'><?php echo $d->strnama?></td>
...
<td colspan="2" align="center">
               ...
               <tr class="detail2">
                    ...
                    <td align="justify"><?php echo "Rp. ".number_format($default[0]->inttotal_omset,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                    <td width="170" align="center">&nbsp;</td>
                    <td width="268" align="center">&nbsp;</td>
                    <td width="114" align="left">PV</td>
                    <td><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;".number_format($default[0]->intpv,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                    <td width="170" align="center">&nbsp;</td>
                    <td width="268" align="center">&nbsp;</td>
					...
					$cicil = ($cicilan*$default[0]->qty);
					echo "Rp. ".number_format($cicil,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                    <td width="170" align="center">&nbsp;</td>
                    <td width="268" align="center">&nbsp;</td>
                    <td width="114" align="left">Komisi 20%</td>
                    <td align="justify"><?php echo "Rp. ".number_format($default[0]->intkomisi20,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                    <td width="170" align="center">&nbsp;</td>
                    <td width="268" align="center">&nbsp;</td>
                    <td width="114" align="left">Komisi 10%</td>
                    <td align="justify"><?php echo "Rp. ".number_format($default[0]->intkomisi10,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                	<td>&nbsp;</td>
                    <td>&nbsp;</td>
                    ...
                    <td align="justify"><?php 
					$cash = $cicil - $default[0]->intkomisi20 - $default[0]->intkomisi10;
					echo "Rp. ".number_format($cash,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">  
                	<td>&nbsp;</td>
                    <td>&nbsp;</td>
