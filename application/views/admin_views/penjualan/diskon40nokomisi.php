...
////////////////////////////////////////////////////////
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">promo diskon 40% No Komisi</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>penjualan/nota" method="post" name="frmjual" id="frmjual">
						<input type="hidden" name="halaman"  value="dis40NoKomisi">
						<input type="hidden" name="nokomisi" id="nokomisi" value="1"> 
	...
	if($('#intid_jpenjualan').val() != 7) {
        ...
        //new fahmi
			...
			if ($('#jumlahsementara').val()!= ""){
				...
				if($('#nokomisi').val() == 1){
				$('#intjumlah1').val(formatAsDollars(0));
 ...
 */	
		//untuk menghitung jumlah omset 10 20 total omset total bayar
		/* var _nokomisi10 = 0;
		var _nokomisi20 = 0;
		if($('#nokomisi').val() != 1){
			_nokomisi10 = _totalHarga10;
			_nokomisi20 =_totalHarga20;
		} */
		$('#intjumlah1').val(_totalHarga10);
		$('#intjumlah2').val(_totalHarga20 + _totalHargaNormal);
		$('#intjumlah').val(parseInt($('#intjumlah1').val()) + parseInt($('#intjumlah2').val()) + _totalHargaFreeHUT + _totalHargaFrees);
    ...
    function diskon40(){
        	...
        	if ($("#tracker002").val() == "bayar")
        	{
               /*  var ur = "<?php echo base_url(); ?>penjualan/lookupBarangDiskon40"; */
                var ur = "<?php echo base_url(); ?>penjualan/lookupBarangDiskon40nokomisi";
                $(".id1").autocomplete({
                    minLength: 5,
                    source:
                        function(req, add){
