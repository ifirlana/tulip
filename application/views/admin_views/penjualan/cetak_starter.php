...
<table width="800" align="center" >
	<tr class="detail2">
        ...
        <tr class="detail">
            <td > Nama&nbsp;&nbsp;&nbsp;: <?php echo $default[0]->strnama_dealer?></td>
            <td width="41">&nbsp;</td>
        </tr>
        <tr class="detail">
		...
		<?php
			if(isset($default[0]->barcode_data)){
				echo "<tr><td>BARCODE DATA : ".$default[0]->barcode_data."</td></tr>";
			}
		?>
    </table>    </td>
    <tr>
			...
			<tr class="detail2">
                ...
                foreach($default as  $d):
					if($d->is_free == 1){
						...
						elseif($d->intid_wilayah==2) {
                            $harga = $d->intharga_luarjawa;
                        }
						elseif($d->intid_wilayah==3) {
                            $harga = $d->intharga_kualalumpur;
                        }
						elseif($d->intid_wilayah==4) {
                            $harga = $d->intharga_luarkualalumpur;
                        }
                    }
				?>
                <tr>
...
<td colspan="2" align="center">
               ...
               <tr class="detail2">
                    <td colspan="2" >&nbsp;</td>
                 <td width="142" align="left">DP</td>
                 <td width="142" align="justify"><?php echo "Rp. ".number_format($default[0]->intdp,2 , ',' , '.')?></td>
                </tr>
