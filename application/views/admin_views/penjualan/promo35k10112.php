...
////////////////////////////////////////////////////////
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">Penjualan Bintulu</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>penjualan/nota" method="post" name="frmjual" id="frmjual">
						<input type="hidden" name="halaman"  value="bin35k10">
...
<!-- //999 -->
							  ...
							  */
                              ...
                              <tr id="showattrlainlain3">
									...
									<td ><input type="checkbox" name="chktulip50_10" id="chktulip50_10"  <?php if($id_cabang == 28 or $id_cabang == 1 or $id_cabang == 104){?><?php }else{?>disabled<?php }?>/>
                                    </td> 
                                </tr>
								<tr id="showattrlainlain3">
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
									<td colspan="3">Special Price</td>
									<td ><input type="checkbox" name="chktulipsp" id="chktulipsp"  <?php if($id_cabang == 28 or $id_cabang == 1 or $id_cabang == 104){?><?php }else{?>disabled<?php }?>/>
                                    </td> 
                                </tr>
								...
								<tr id="showattrlainlain5" style="display:none;">
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
									<td colspan="3">Tulip 50% net</td>
									<td >
										<input type="checkbox" name="chktulip50_net" id="chktulip50_net" />
                                    </td>
                                </tr>
								<tr id="showattrlainlain5" style="display:none;">
									<td>&nbsp;</td>
								...
								<tr id="showattrlainlain5" style="display:none;">
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
									<td colspan="3">Tulip 35% Komisi 10%</td>
									<td >
										<input type="checkbox" name="chktulip35_10" id="chktulip35_10" />
                                    </td>
                                </tr>
...
function jpenjualan(inicari){
	$.ajax({
		url:"<?php echo base_url(); ?>promo60net/lookuppenjualan",
		type:'POST',
...
$(document).delegate('#chktulip25_10', 'change', function(){
	...
	$(document).delegate('#chktulip50_10','change',function(){
		jpenjualan('dis50k10');
	});
	$(document).delegate('#chktulip50_net','change',function(){
		jpenjualan('bin50net');
	});
	$(document).delegate('#chktulip60_net','change',function(){
		jpenjualan('dis60net');
	});
	$(document).delegate('#chktulipsp','change',function(){
		jpenjualan('spnet');
	});
...
//001
	...
	if($("#track6").val() == 0) {$("#metal_6").removeAttr("disabled");}
        ...
        if(($(".id1").val()=="") &&($(".frees").val()=="")){
            ...
            else if($("#chkBox10").attr('checked') == true || $("#chktulip50_10").attr("checked") == true || $("#chktulip35_10").attr("checked") == true || $("#chktulip25_10").attr("checked") == true || $("#chktulip30_10").attr("checked") == true||$("#chktulip20_10").attr("checked") == true){ // else if($("#chkBox10").attr('checked') == true){
...
/* 				pv	=	(parseFloat(pv) * 0.4).toFixed(2); */
				...
				if($("#chktulip50_net").attr("checked") == true){
				
				// harga = harga * 0.7; 
				harga = /*  Math.ceil */(parseFloat(harga) * 0.5).toFixed(2);
/* 				pv	=	(parseFloat(pv) * 0.4).toFixed(2); */
				autoComp();
				kali();
				}
...
/* 				pv	=	(parseFloat(pv) * 0.4).toFixed(2); */
				...
				if($("#chktulip35_10").attr("checked") == true){
				
				// harga = harga * 0.7; 
				harga = /*  Math.ceil */(parseFloat(harga) * 0.65).toFixed(2);
/* 				pv	=	(parseFloat(pv) * 0.4).toFixed(2); */
				autoComp();
				kali();
				}
			...
			if($("#intid_jpenjualan").val() == 7 || $("#intid_jpenjualan").val() == 11 || $("#intid_jpenjualan").val() == 19){
...
//sasaran fahmi
        }else if($("#chkBox10").attr('checked') == true || $("#chktulip30_10").attr('checked') == true || $("#chktulip20_10").attr('checked') == true  || $("#chktulip35_10").attr('checked') == true || $("#chktulip50_10").attr('checked') == true || $("#intid_jpenjualan").val()==20 ){
	...
	if($('#intid_jpenjualan').val() != 7) {
		...
		else if($("#intid_jpenjualan").val()==11 ){
		//for netto
			var csaja = document.getElementsByName("hitaja[]").length;
            for(var i=1; i<= parseFloat(id);i++){
			...
			console.log("Ini berdasarkan pemilihan jenis penjualan 11");
			$('#intjumlahhidden').val('0');
			$('#intjumlah').val('0');
			$('#intjumlah1').val('0');
				$('#intjumlah2').val('0');
 ...
 */			
        ...
        if($('#intjumlahhidden').val() == ""){
            ...
            var intjum = parseFloat($('#intjumlahhidden').val());
        }
        ...
        $('#totalbayar').val(formatAsDollars((totals).toFixed(2)));
        $('#totalbayar1').val((totals).toFixed(2));
	...
	/* punyafahmibaru */
	 if($("#intid_jpenjualan").val() < 9 || $("#intid_jpenjualan").val() == 11 || $("#intid_jpenjualan").val() == 19) {
		kali_baru(id);
	}  
    }
    ...
    $("#chktulip60_net").click(function(){
      if ($('#chktulip60_net').attr('checked') == true){
		  ...
		  $("#chktulip20_sb").attr("disabled","disabled");
		  $("#chktulip20_10").attr("disabled","disabled");
		  $("#chktulipsp").attr("disabled","disabled");
		  $("#chktulip50_10").attr("disabled","disabled");
		  $("#chktulip50_net").attr("disabled","disabled");
		  $("#chktulip20_10").attr("disabled","disabled");
  		  $("#chktulip35_10").attr("disabled","disabled");
  		  $("#chktulip25_10").attr("disabled","disabled");
		   $('#brgsuka').removeAttr('disabled');
		   jbarang = 0;
		   autoComp();
	  }else{
		 /* $('#chktulip20_10').removeAttr('disabled'); */
		  $('#chktulip20_20').removeAttr('disabled');
 		 $('#chktulip50_10').removeAttr('disabled');
 		 $('#chktulipsp').removeAttr('disabled');
 		 $('#chktulip50_net').removeAttr('disabled');
 		 $('#chktulip35_10').removeAttr('disabled');
 		 $('#chktulip25_10').removeAttr('disabled');
		 
		 $('#chktulip20_20').removeAttr('disabled');
		 $("#brgsuka").attr("disabled","disabled");
	  }
    });
	$("#chktulipsp").click(function(){
      if ($('#chktulipsp').attr('checked') == true){
		  $("#chktulip20_20").attr("disabled","disabled");
		  $("#chktulip20_sb").attr("disabled","disabled");
		 ...
		 /* $('#chktulip20_10').removeAttr('disabled'); */
		  $('#chktulip20_20').removeAttr('disabled');
 		 $('#chktulip50_10').removeAttr('disabled');
 		 $('#chktulip60_net').removeAttr('disabled');
 		 $('#chktulip50_net').removeAttr('disabled');
 		 $('#chktulip35_10').removeAttr('disabled');
 		 $('#chktulip25_10').removeAttr('disabled');
...
|______________________________________________________________________*/
		...
		//	alert("4");
			...
			if($("#chktulip50_10").attr("checked") == true){ //tulip 50 komisi 10
				...
				autoCompPromo50();//config
					...
					if( $("#chktulip35_10").attr("checked") == true || $("#chktulip50_net").attr("checked") == true){
						autoCompPromoConfig();
						console.log('3510');
					}else if ($('#intid_jpenjualan').attr('value') == 11){
						autoCompPromoSpecialBin();
					}else{
						autoCompPromoNormal();
					}
					}
	...
	*/
	...
	}function autoCompPromoConfig() {
		$(".id1").autocomplete({
                    minLength: 5,
                    source:
                        function(req, add){
                        $.ajax({
                            url: "<?php echo base_url(); ?>penjualan/lookupBarangControlPromoF4",
                            dataType: 'json',
                            type: 'POST',
                            //data: req,
                            data:{
	...
	*/
	...
	/* else if($("#chktulip35_10").attr('checked') == true){
		aturlook='lookupBarang';
	} */else{
	...
	*/
	...
	function autoCompPromoSpecialBin() {
		$(".id1").autocomplete({
                    minLength: 5,
                    source:
                        function(req, add){
                        $.ajax({
                            url: "<?php echo base_url(); ?>penjualan/lookupBarangSpcBintulu",
                            dataType: 'json',
                            type: 'POST',
                            data: req,
							success:
	...
	*/
	$('#intid_jpenjualan').change(function(){
		...
		if ($('#intid_jpenjualan').attr('value')== 1)
		{
			...
			var title = "Nota Penjualan Spesial Price";
			$('#title').text(title);
			$("#post_intid_jpenjualan").val($("#intid_jpenjualan").val());
		}
		else if ($('#intid_jpenjualan').attr('value')== 13) {
			...
			autoComp();
		}else if ($('#intid_jpenjualan').attr('value')== 20) {
			var title = "Nota Penjualan Diskon 35%";
			$('#title').text(title);
			$("#chkSmart").attr("checked",false);
			$("#chkSmart").attr("disabled","disabled");
			autoComp();
	...
	*/
	$('#chkSmart').click(function(){
		...
		{
			if ($('#intid_jpenjualan').attr('value') == 2 || $('#intid_jpenjualan').attr('value') == 3 || $('#intid_jpenjualan').attr('value') == 4 || $('#intid_jpenjualan').attr('value') == 5 || $('#intid_jpenjualan').attr('value') == 6 || $('#intid_jpenjualan').attr('value') == 7 || $('#intid_jpenjualan').attr('value') == 11 || $('#intid_jpenjualan').attr('value') == 19)
			{
				$("#chkBox10").attr("checked",false);
				$("#chkBox20").attr("checked",false);
				$("#chkBoxTrade").attr("checked",false);
	...
	*/
	function kali_baru(id){
		...
		if ($('#intjumlah1').val() != '' && $('#intid_jpenjualan').attr('value') != 4 && $('#intid_jpenjualan').attr('value') != 7 && $('#intid_jpenjualan').attr('value') != 11 && $('#intid_jpenjualan').attr('value') != 19 && $('#intid_jpenjualan').attr('value') != 8)
		{
		...
		if ($('#intjumlah2').val() != '' && $('#intid_jpenjualan').attr('value') != 4 && $('#intid_jpenjualan').attr('value') != 7 && $('#intid_jpenjualan').attr('value') != 11 && $('#intid_jpenjualan').attr('value') != 19 && $('#intid_jpenjualan').attr('value') != 8)
		{
		...
		if ($('#intid_jpenjualan').attr('value') == 19)
		{
			...
			$('#intpv').val(0);
		}if ($('#intid_jpenjualan').attr('value') == 11)
		{
			$('#komisi1').val(0);
			$('#komisi2').val(0);
			$('#intjumlah2').val(0);
