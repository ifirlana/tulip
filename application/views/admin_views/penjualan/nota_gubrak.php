		...
		///		alert('masuk');
			...
			$(this).val() = q;
                    ...
                    select:
                        function(event, ui) {
                        $("#result2").html(
                        "done<input type='text' id='harga_barang_free' name='harga_barang_free' value='0' size='5' readonly='readonly'/><input type='hidden' id='id_free' name='id_free' value='" + ui.item.id + "' size='15' /><input type='hidden' id='pv' name='pv' value='0' size='15' readonly='readonly'/>"
                    );
                    },
                });
                ...
                <div>	<h2 class="title">penjualan</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>penjualan/nota" method="post" name="frmjual" id="frmjual">
                            <input type="hidden" name="halaman" readonly="readonly" value="gbrak">
...
//line ikhlas firlana 30032013
            $('#intjumlah1').val(formatAsDollars(sall));
            $('#intjumlah1hidden').val(sall);
//sebelumnya
    ...
    function auto(){
		...
		$(this).val() = q;
            ...
            select:
                function(event, ui) {
                $("#result1").append(
                "done<input type='text' id='id_barang' name='id_barang' value='" + ui.item.value1 + "' size='15' /><input type='hidden' id='id_barang' name='id_barang' value='" + ui.item.id + "' size='15' /><input type='text' id='pv' name='pv' value='" + ui.item.value3 + "' size='15' readonly='readonly'/><input type='hidden' id='id_harga' name='id_harga' value='" + ui.item.value5 + "' size='15' />"
            );
            },
        });
