...
<script type="text/javascript">
				...
				var totlglain = 0;
				totlglain = parseInt(parseInt($('#total').val()) / 350000);
				
				$('#totallg001').val(totlglain);
				alert('Total Yang Akan Ditebus '+totlglain+'');
                      ...
                      <td width="94" rowspan="3"><div id="data">
							...
							<input type="hidden" id="totallg001" name="totallg001" value="0" />
                                ...
                                <tr>
                                    ...
                                    <input name="intid_jpenjualan" type="hidden" value="25" /></td>
                                </tr>
                            </table>
          </td>
                            </tr>
