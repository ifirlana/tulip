...
//sasaran fahmi
        }else if($("#chkBox10").attr('checked') == true || $("#chktulip30_10").attr('checked') == true || $("#chktulip20_10").attr('checked') == true  || $("#chktulip35_10").attr('checked') == true || $("#intid_jpenjualan").val()==20 ){
