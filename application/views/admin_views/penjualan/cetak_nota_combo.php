	...
	<tr class="detail2">
        ...
        <tr class="detail">
          ...
          <td width="203"> <?php echo $default[0]->strnama_cabang?>, <?php echo date('d-m-Y', strtotime($default[0]->datetgl))?></td>
     	  <td width="41"><a href="javascript:window.print()" onclick="<?php if(isset($url)){echo "location.href='".$url."'";}else{echo "location.href='".base_url()."/penjualan/'";}?>"><img src="<?php echo base_url();?>/images/print.jpg"/></a></td>
        </tr>
        <tr class="detail">
