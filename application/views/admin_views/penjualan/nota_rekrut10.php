...
<div id="page1">
    <div id="wrapper">
        ...
        <script type="text/javascript">
			...
			$('#cekomset').click(function() {
				...
				$.ajax({					
					url: "<?php echo base_url(); ?>penjualan/check_omset_rekrut_sepuluh",
					type: 'POST',
					async : false,
					data: form_data,
					beforeSend:
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">Penjualan Tebus Rekrut Untuk 10 Orang</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>penjualan/lglainrekrut10" method="post" name="frmjual" id="frmjual">
                            ...
                            <table width="685" border="0" id="data" align="center">
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td><input type="button" name="button" id="cekomset" value="Cek Rekrut" />
											<input type="hidden" name="is_ten" value="1"/> </td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                </tr>
