...
////////////////////////////////////////////////////////
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">Penjualan Voucher</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>voucher/nota" method="post" name="frmjual" id="frmjual">
...
<!-- //999 -->
							  ...
							  */
                              ...
                              <tr id="showattrlainlain3" style="display:none;">
								...
								<tr id="showattrlainlain4" >
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
									<td colspan="3">Kode Voucher</td>
									<td ><input type="text" name="txtkodevoucher" id="txtkodevoucher"  /><button id ="cekVoucher" >Cek Voucher</button>
                                    </td>
                                </tr>
								<tr id="showattrlainlain5" >
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
									<td colspan="3">Nominal Voucher</td>
									<td ><input type="text" name="intvoucher" id="txtnominalkodevoucher"  value="0"  readonly/>
                                    </td>
                                </tr>
								<tr id="showattrlainlain5" >
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
									<td colspan="3">Kondisi Voucher</td>
									<td >
									<input type="text" name="txtrulekodevoucher" id="txtrulekodevoucher" value="0"  readonly/>
                                    </td>
                                </tr>
                                <tr>
...
<td width="63" rowspan="3"><div id="data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="jml2023" id="intjumlah2hidden"/>
                                        <input type="hidden" name="jml20" value="0"/>
                                        ...
                                        <input type="hidden" name="intvoucher_lama" id="intvoucher"/>
                                ...
                                <tr id="sisa">
                                  ...
                                  <td>&nbsp;:</td>
                                    <td>Rp.<input type="text" name="intsisa" id="intsisa" onkeypress="return isNumberKey(event)" />
                                        ...
                                        <input type="hidden" name="kodevoucheracc" id="kodevoucheracc" />                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
...
/* Line cek Voucher fahmi */

	$('#cekVoucher').bind('click', function(e){
		$("#txtkodevoucher").attr("disabled","disabled");
		$("#cekVoucher").attr("disabled","disabled");
		
		//alert('asda'+$('#intjumlah').val());
		$.ajax({
                            url: "<?php echo base_url(); ?>voucher/cekKode",
                            dataType: 'json',
                            type: 'POST',
                            data: {
                                keykode: $('#txtkodevoucher').val(),
                            ...
                            success:
                                ...
                                if(data.response =="true"){
								/* console.log(data.isi.nominal); */
                                     $('#txtnominalkodevoucher').val(data.isi.nominal);
                                     $('#txtrulekodevoucher').val(data.isi.nominal_controll);
                                     $('#kodevoucheracc').val($('#txtkodevoucher').val());
									 alert("Kode Voucher Diterima.");
                                }else
								{
									alert("Kode Voucher Sudah Di Gunakan / Tidak Terdaftar !! \n Silahkan Input Kode Voucher Baru \n Atau Hubungin Admin Untuk Claim");
									$("#txtkodevoucher").removeAttr("disabled");
									$("#cekVoucher").removeAttr("disabled");
								}
                            },
                        });
	...
	function omsetUbah(isiNilai){
		var hasilVoucher=0;
		//console.log();
		if(isiNilai>=$('#txtrulekodevoucher').val()){
		//alert('di ubah '+ isiNilai+' : ');
		hasilVoucher = isiNilai - $('#txtnominalkodevoucher').val();
		 console.log(hasilVoucher);
		 $('#totalbayar').val(hasilVoucher);
		 $('#totalbayar1').val(hasilVoucher);
		}
		//return false;
	}
	/* end line cek voucher fahmi */
	$('#addBrg').bind('click', function(e){
	...
	if($('#intid_jpenjualan').val() != 7) {
		...
		//for netto
            ...
            for(var i=1; i<= parseInt(id);i++){
				...
				//line netto fahmi
				if(total>$('#txtrulekodevoucher').val() && $('#txtrulekodevoucher').val() != 0){
				total = total - $('#txtnominalkodevoucher').val();
				}
                $('#intjumlah2hidden').val(total);
				//omsetUbah(total);
        //end netto
		...
		if(totals>$('#txtrulekodevoucher').val() && $('#txtrulekodevoucher').val() != 0){
		//alert('di ubah '+ totals+' : ');
		voch = $('#txtnominalkodevoucher').val();
		totals = omset - kom1 - kom2 /* - $('#txtnominalkodevoucher').val() */;
		/* hasilVoucher = isiNilai - $('#txtnominalkodevoucher').val();
		 console.log(hasilVoucher);
		 $('#totalbayar').val(hasilVoucher);
		 $('#totalbayar1').val(hasilVoucher); */
