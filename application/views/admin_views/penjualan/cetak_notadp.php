...
<div class="page">
	...
	<div class="content" style="margin-left:10px;margin-top:30px;">
		...
		<div class="block">
			<div>DP</div>
			<div class="bayar"><?php echo "Rp. ".number_format($default[0]->intdp,0 , ',' , '.')?></div>
		</div>
		<div class="block">
			<div>Debit</div>
...
<table width="800" align="center">
	<tr class="detail2">
        ...
        <tr class="detail">
          ...
          <td width="203" class="detail2"> <?php echo $default[0]->strnama_cabang?>, <?php echo date('d-m-Y', strtotime($default[0]->datetgl))?></td>
     	  <td width="41"><a href="javascript:window.print()" onclick="location.href='<?php echo base_url();?>penjualan/nota';"><img src="<?php echo base_url();?>/images/print.jpg"/></a></td>
        </tr>
        <tr class="detail">
        ...
        <tr align="center">
            <td colspan="2" class="judul"><h3>
				...
				?>        	
                 Nota Penjualan <?php echo $judul;?></h3></td>
                <td>&nbsp;</td>
        </tr>
    </table>
    </td>
    <tr>
    	<td colspan="2" align="center">
			...
			<tr class="detail2">
                	<th width="184">Banyaknya</th>
              <th style="padding:0 10px 0 10px;">Nama Barang</th>
              <th width="133">Harga</th>
              <th width="143">Jumlah</th>
              </tr>
                <tr>
                	<td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                foreach($default as  $d):
                    ...
                    ?>
                <tr>
                    <td align="center" class="detail" id='style-css'><?php echo $d->intquantity?></td>
                    <td align="left" class="detail" id='style-css-nama'><?php echo $d->strnama?></td>
                    <td align="justify"class="detail" id='style-css'><?php echo "Rp. ".number_format($harga,2 , ',' , '.')?></td>
                  <td align="justify" class="detail" id='style-css'><?php $jumlah = $harga * $d->intquantity; echo "Rp. ".number_format($jumlah,2 , ',' , '.');
                    $total = $total + $jumlah;
                    ?></td>
              </tr>
                <?php endforeach;?>
...
<td colspan="2" align="center">
               ...
               <tr class="detail2">
                    <td colspan="2" >&nbsp;</td>
                 <td width="134" align="left" class='style-css'>Voucher</td>
                 <td width="147" align="justify" class='style-css'><?php echo "Rp. ".number_format($default[0]->intvoucher,2 , ',' , '.')?></td>
                </tr>
               <tr class="detail2">
                 <td colspan="2" >&nbsp;</td>
                 <td width="134" align="left" class='style-css'>Omset</td>
                 <td align="justify" class='style-css'><?php echo "Rp. ".number_format($default[0]->inttotal_omset,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                  <td width="134" align="left" class='style-css'>PV</td>
                  <td align="justify" class='style-css'><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".number_format($default[0]->intpv,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                  <td width="134" align="left" class='style-css'>Komisi 20%</td>
                  <td align="justify" class='style-css'><?php echo "Rp. ".number_format($default[0]->intkomisi20,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                  <td width="134" align="left" class='style-css'>Komisi 10%</td>
                  <td align="justify" class='style-css'><?php echo "Rp. ".number_format($default[0]->intkomisi10,2 , ',' , '.')?></td>
                </tr >
               <tr class="detail2">
                 <td colspan="2" >&nbsp;</td>
                 <td width="134" align="left" class='style-css'>Total Bayar</td>
                ...
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                    ...
                    <td align="justify" class='style-css'><?php echo "Rp. ".number_format($default[0]->intdp,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                ...
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                	<td "left" class='style-css'>Sisa</td>
