...
//001
	...
	if($("#track6").val() == 0) {$("#metal_6").removeAttr("disabled");}
        ...
        if(($(".id1").val()=="") &&($(".frees").val()=="")){
            ...
            if($("#chkBox20").attr('checked') == true || $("#chktulip20_20").attr("checked") == true || $("#chktulip20_sb").attr("checked") == true){
            ...
            else if($("#chkBox10").attr('checked') == true || $("#chktulip50_10").attr("checked") == true||$("#chktulip30_10").attr("checked") == true||$("#chktulip20_10").attr("checked") == true){ // else if($("#chkBox10").attr('checked') == true){
			...
			else if($("#intid_jpenjualan").val() == 26){ // chall sc
                ...
                out += '<input type="hidden" class="status_free_'+idx+'" value="'+status_free+'"><input type="hidden" id="hitaja" name="hitaja[]" value="'+idx+'">';
            }
...
//sasaran fahmi
	...
	if($('#intid_jpenjualan').val() != 7) {
		...
		} else if($("#intid_jpenjualan").val()==7 || $("#intid_jpenjualan").val()==26){
		//for netto
			//var csaja = document.getElementsByName("hitaja[]").length;
            for(var i=1; i<= parseInt(id);i++){
...
|______________________________________________________________________*/
	...
	/* fahmijenis */
		...
		//	alert("4");
			...
			if($("#chktulip50_10").attr("checked") == true){ //tulip 50 komisi 10
				...
				if( $("#chktulip20_sb").attr("checked") == true){
					autoCompPromo20Bayar();
				}else  if( $("#chktulip20_10").attr("checked") == true ){
				autoCompPromoNormalMetal();
				}
				else{
					autoCompPromoNormal();}
	...
	*/
	$('#intid_jpenjualan').change(function(){
		...
		else if ($('#intid_jpenjualan').attr('value')== 26) {
			var title = "Nota Penjualan CHALL SC";
			$('#title').text(title);
			$("#chkSmart").attr("checked",false);
			$("#chkSmart").attr("disabled","disabled");
			$("#chktulip30_10").attr("disabled","disabled");
			$("#brgsuka").removeAttr("disabled","disabled");
			$("#post_intid_jpenjualan").val($("#intid_jpenjualan").val());
			autoComp();
		}
	});
	...
	*/
	function kali_baru(id){
		...
		$('#intjumlah2').val(_totalHarga20 );
		$('#intjumlah').val(parseInt($('#intjumlah1').val()) + parseInt($('#intjumlah2').val()) + _totalHargaFreeHUT + _totalHargaFrees+ _totalHargaNormal);
		...
		/* fahmitracker */
			if($("#chktulip50_10").attr("checked") == true||$("#chktulip30_10").attr("checked") == true/* ||$("#chktulip20_10").attr("checked") == true */ ||$("#chktulip20_sb").attr("checked") == true /* && status_free == 1 */){
				if (parseInt($('#total_'+ i).val()) >= 0 && parseInt($('#harga_'+ i).val()) >= 0 && parseFloat($('#pv_'+ i).val()) >= 0) {
					...
					if (parseInt($('.sepuluh_'+ i).val()) > 0 && $("#chktulip20_10").attr("checked") == true) {
						console.log(_tempCount+' ada'); 
						_tempCount += parseInt($('.sepuluh_'+ i).val()) /* / 2 */;
					}
					if (parseInt($('.duapuluh_'+ i).val()) > 0 && $("#chktulip20_sb").attr("checked") == true) {
						console.log(_tempCount+' ada'); 
						_tempCount += parseInt($('.duapuluh_'+ i).val()) /* / 2 */;
					}
		...
		if ((parseInt($('#tracker004').val()) > _totalQuantityFree + _totalQuantityFree20) && (status_free == 1) ) {
			//if( $("#chktulip50_10").attr("checked") != true){ //not working
				...
				alert("Silakan pilih barang freeeeeeeeeeez");
				$('#tracker002').val("free");
				status_free = 0;
				//}
			//	else{
		...
		if ((parseInt($('#tracker004').val()) > _totalQuantityFree + _totalQuantityFree20) /* || $("#chktulip20_10").attr("checked") == true */ || $("#chktulip20_sb").attr("checked") == true ) {
			//if( $("#chktulip50_10").attr("checked") != true){ //not working
