...
<div id="page1">
    <div id="wrapper">
        ...
        <script type="text/javascript">
			...
			$('#cekomset').click(function() {
				...
				$.ajax({					
					url: "<?php echo base_url(); ?>universe/check_omset_universe",
					type: 'POST',
					async : false,
					data: form_data,
					success:
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">penjualan lg</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>universe/lgwithweek" method="post" name="frmjual" id="frmjual">
                  ...
                  <?php
                    ...
                    ?>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td><input type="button" name="button" id="cekomset" value="Cek Omset" /><input type="hidden" name="is_lg" value="1"/> </td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                </tr>
