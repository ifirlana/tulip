...
<title>Cetak Lunas Nota</title><?php $this->load->helper('HTML');
...
<div class="page">
	<div class="header">
		...
		<div style="width:20px;margin-left:50px"><a href="javascript:window.print()" onclick="location.href='nota';"><img width="30px" src="<?php echo base_url();?>/images/print.jpg"/></a></div>
	</div>
	...
	<div class="content" style="margin-left:10px;margin-top:30px;">
		...
		<div class="block">
			<div>DP</div>
			<div class="bayar"><?php echo "Rp. ".number_format($default[0]->intdp,2 , ',' , '.')?></div>
		</div>
		<div class="block">
			<div>Cash</div>
...
<table width="800" align="center" >
	<tr class="detail2">
        ...
        <table width="800" align="center" >
        <tr class="detail">
          <td width="510" rowspan="4" valign="top"><img src="<?php echo base_url();?>images/logo.jpg" />&nbsp;</td>
          <td width="225"> <?php echo $default[0]->strnama_cabang?>, <?php echo date('d-m-Y', strtotime($default[0]->datetgl))?></td>
     	  <td width="49"><a href="javascript:window.print()" onclick="location.href='penjualan/nota';"><img src="<?php echo base_url();?>/images/print.jpg"/></a></td>
        </tr>
        <tr class="detail">
        ...
        <tr class="detail">
            <td align="justify"><h3> Unit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $default[0]->strnama_unit?></h3> </td>
            <td>&nbsp;</td>
        </tr>
        <tr  class="detail">
            <td colspan="2" class="dats">
    ...
    <tr>
    	<td colspan="2" align="center">
			...
			<tr class="detail2">
                	<th>Banyaknya</th>
                    <th  style="padding:0 10px 0 10px;">Nama Barang</th>
                    <th>Harga</th>
                    <th>Jumlah</th>
                </tr>
                <tr>
                ...
                <tr class="data">
                    ...
                    <td align="justify"  class='style-css-nama'><?php echo $d->strnama?></td>
...
<td colspan="2" align="center">
               ...
               <tr class="detail2">
                    <td colspan="2" >&nbsp;</td>
                    <td width="129" align="left">Voucher</td>
                 <td width="143" align="justify"><?php echo "Rp. ".number_format($default[0]->intvoucher,2 , ',' , '.')?></td>
                </tr>
               <tr class="detail2">
                 <td colspan="2" >&nbsp;</td>
                    <td width="129"align="left">Omset</td>
                 <td align="justify"><?php echo "Rp. ".number_format($default[0]->inttotal_omset,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                    <td width="129" align="left">PV</td>
                  <td align="justify"><?php echo "Rp. ".number_format($default[0]->intpv,2 , ',' , '.')?></td>
                </tr>
                 <tr class="detail2">
                   <td colspan="2" >&nbsp;</td>
                    <td width="129" align="left">Komisi 20%</td>
                   <td align="justify"><?php echo "Rp. ".number_format($default[0]->intkomisi20,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                    <td width="129" align="left">Komisi 10%</td>
                  <td align="justify"><?php echo "Rp. ".number_format($default[0]->intkomisi10,2 , ',' , '.')?></td>
                </tr>
               <tr class="detail2">
                 <td colspan="2" >&nbsp;</td>
                    <td width="129"align="left">Total Bayar</td>
                 <td align="justify"> <?php echo "Rp. ".number_format($default[0]->inttotal_bayar,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                    <td width="129" align="left">DP</td>
                  <td align="justify"><?php echo "Rp. ".number_format($default[0]->intdp,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
                	<td align="left">Cash</td>
                    <td align="justify"><?php echo "Rp. ".number_format($default[0]->intcash,2 , ',' , '.')?></td>
                </tr>
                <tr class="detail2">
                  <td colspan="2" >&nbsp;</td>
