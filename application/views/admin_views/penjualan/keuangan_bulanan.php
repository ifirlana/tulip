...
<table width="754" align="center" >
    ...
    <table width="754" align="center" class="detail" border="0">
         ...
         <tr align="center" class="judul">
            <td>
LAPORAN PEMBAYARAN <?php echo $cabang;?></td>
          </tr>
          <tr align="center">
            <td>PERIODE <?php if ($month=='01')
		  { 
		  	echo 'JANUARI';
		  } else if ($month=='02')
		  {
			...
			?>
			 ...
			 ?>
              ...
              <td width="164">&nbsp;</td>
                ...
                <tr>
                	<td colspan="3"><table width="100%" border="1" align="center" class="detail">
			<tr class="detail2">
                ...
                ?>
                <tr>
                    <td align="center" class="data"><?php echo $d->datetanggal?></td>
