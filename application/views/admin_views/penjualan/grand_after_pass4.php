...
<script type="text/javascript">
	...
	$('#addBrg').bind('click', function(e){
		if($(".id1").val()==""){
			...
			out += '<input type="text" id="harga_asli_'+idx+'" name="barang['+idx+'][harga_asli]" value="'+harga_asli+'"/>';
			out += '<input type="text" id="pv_asli_'+idx+'" name="barang['+idx+'][pv_asli]" value="'+pv_asli+'"/>';
			out += '<input type="text" id="promodiskon_'+idx+'" name="barang['+idx+'][promodiskon]" value="'+promodiskon+'"/>';
...
$("#chktulip30_10").click(function(){
		promodiskon= 0.7;
		console.log('cilukba : '+ promodiskon);
		});
	/*
		...
		for (var i = 1; i <= parseInt($('#tracker001').val()); i++) {
			...
			if ($('#voucher_'+ i).attr("checked") == true) {
				...
				else if (parseInt($('.sepuluh_'+ i).val()) >= 0)
				{
					var _xpv = 0;
					/* $('#total_' + i).val(parseInt($('#total_' + i).val()) - _v); */
					parseInt($('#harga_' + i).val((parseInt($('#harga_asli_' + i).val()) - _v)*$('#promodiskon_' + i).val()));
					$('#total_' + i).val((parseInt($('#harga_asli_' + i).val()) - _v)*$('#promodiskon_' + i).val());
					if (parseInt($('#total_' + i).val()) < 0)
					{
						_v = parseInt($('.sepuluh_' + i).val()) * parseInt($('#harga_'+ i).val());
						$('#total_' + i).val(0);
					...
					console.log(_xpv);
					console.log((($('#pv_asli_' + i).val() - _xpv)*$('#promodiskon_' + i).val()).toFixed(2));
					//fahmifloat
					$('#pv_' + i).val((($('#pv_asli_' + i).val() - _xpv)*$('#promodiskon_' + i).val()).toFixed(2))
					//console.log(parseFloat($('#pv_' + i).val(($('#pv_asli_' + i).val() - _xpv)*$('#promodiskon_' + i).val())).toFixed(2));
					console.log(((($('#harga_asli_' + i).val()) )*$('#promodiskon_' + i).val()).toFixed(2));
					//_totalHarga10 = _totalHarga10 - ((parseInt($('#harga_asli_' + i).val()) )*$('#promodiskon_' + i).val());
					//console.log(_totalHarga10);
					_totalHarga10 -= parseInt((($('#harga_asli_' + i).val()) )*$('#promodiskon_' + i).val()).toFixed(2);
					_totalHarga10 += parseInt((($('#harga_asli_' + i).val()) - _v)*$('#promodiskon_' + i).val()).toFixed(2);
					//_totalHarga10 -= _v; 
					console.log(_totalHarga10);
					_totalv += _v;
