    ...
    <div id="wrapper">
        ...
        <script type="text/javascript">
            ...
            $(document).ready( function() {
                ...
                $("#intid_unit").autocomplete({
                    ...
                    source:
                        function(req, add){
                        $.ajax({
                            url: "<?php echo base_url(); ?>evan/lookupUnit",
                            dataType: 'json',
                            type: 'POST',
                            data: req,
                            success:
                ...
                $("#strnama_dealer").autocomplete({
                    ...
                    source:
                        function(req, add){
                        $.ajax({
                            url: "<?php echo base_url(); ?>evan/lookupUpline",
                            dataType: 'json',
                            type: 'POST',
                            data: {
                                term: req.term,
            ...
            function autoComp(){
                ...
                var ur = "<?php echo base_url(); ?>evan/lookupBarangPromo10_jbarang";
                ...
                $(".frees").autocomplete({
                    ...
                    source:
                        ...
                        $.ajax({
                            url: "<?php echo base_url(); ?>evan/lookupBarangFree10",
                            dataType: 'json',
                            type: 'POST',
                           	data: {
                                term: req.term,
...
*/
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">3 Free 2</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>evan/nota" method="post" name="frmjual" id="frmjual">
        ...
        <!-- end #content -->
        <?php $this->load->view('admin_views/sidebar_penjualan_menu'); ?><!-- end #sidebar -->
