...
<div id="page">
    ...
    <table border="0" cellpadding="1" cellspacing="1" align="center" width="100%">
      ...
      <tr>
        <td>&nbsp;Nama Barang</td>
        <td><input type="text" name="intid_barang"  id="intid_barang" size="20" value="<?php echo $intid_barang; ?>" /></td>
      </tr>
     
      <tr>
        <td>&nbsp;Supplier</td>
        <td><input type="text" name="supplier" size="20" value="<?php echo $supplier; ?>" /></td>
      </tr>
      <tr>
        <td>&nbsp;Jumlah</td>
        <td><input type="text" name="intqty" size="20" value="<?php echo $intqty; ?>" /></td>
      </tr>
       <tr>
        <td>&nbsp;Tanggal</td>
      ...
      <tr>
            <th></th>
            <td><input type="submit" value="Edit" class="button"/>&nbsp;<input class="button" type="button" value="Cancel" onclick="location.href='<?php echo base_url()?>stok';"/></td>
      </tr>
 </table>
