...
////////////////////////////////////////////////////////
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">penjualan diskon 25% komisi 10%</h2>
                    <div class="entry">
                        <form action="<?php echo base_url()?>penjualan/nota" method="post" name="frmjual" id="frmjual">
						<input type="hidden" name="halaman"  value="probintulu">
							  ...
							  */
                              ...
                              <tr id="showattrlainlain3" style="display:none;">
								...
								<tr id="showattrlainlain3">
									...
									<td ><input type="checkbox" name="chktulip25_10" id="chktulip25_10"  />
                                    </td>
                                </tr>
                                <tr>
...
//001
	...
	if($("#track6").val() == 0) {$("#metal_6").removeAttr("disabled");}
        ...
        if(($(".id1").val()=="") &&($(".frees").val()=="")){
            ...
            else if($("#chkBox10").attr('checked') == true || $("#chktulip25_10").attr("checked") == true || $("#chktulip50_10").attr("checked") == true){ // else if($("#chkBox10").attr('checked') == true){
...
|______________________________________________________________________*/
		...
		//	alert("4");
			...
			if($("#chktulip50_10").attr("checked") == true){ //tulip 50 komisi 10
				...
				autoCompPromo50();//config
					...
					if($("#chktulip25_10").attr("checked") == true){ //tulip 50 komisi 10
						console.log('25_10');
						autoCompPromoNormal();//config
					}else{
						autoCompPromoNormal();
					}
				}
	...
	*/
	function kali_baru(id){
		...
		for (var i = 1; i <= parseInt($('#tracker001').val()); i++) {
			if (parseInt($('#total_'+ i).val()) >= 0 && parseInt($('#harga_'+ i).val()) >= 0 && parseFloat($('#pv_'+ i).val()) >= 0) {
				if (parseInt($('.sepuluh_'+ i).val()) > 0 && $("#chktulip25_10").attr("checked") == false) {
