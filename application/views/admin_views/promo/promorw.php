...
<div id="page1">
    <div id="wrapper">
        ...
        <script type="text/javascript">
			...
			$('#cekomset').click(function() {
				...
				$.ajax({					
					url: "<?php echo base_url(); ?>promorw/checkOmset",
					type: 'POST',
					data: form_data,
					beforeSend:
						function()
    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">Promo MERAh putih</h2>
                    <div class="entry">
                ...
                <input type="hidden" name="nota_intno_nota" size="20" value="<?php echo $max_id?>" readonly/>
                                ...
                                <tr>
                                  <td>&nbsp;Reguler</td>
                                  <td>&nbsp;
                                 <input type="hidden" name="nota_intid_jpenjualan" id="nota_intid_jpenjualan" size="20" value="30" readonly/>
            			</td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
