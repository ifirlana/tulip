    ...
    <div id="wrapper">
        ...
        <script type="text/javascript">
			...
			$('#cekomset').click(function() {
				...
				$.ajax({					
					url: "<?php echo base_url(); ?>promoavenger/checkOmset",
					type: 'POST',
					data: form_data,
					beforeSend:
						function()
        ...
        <div id="page-bgtop">
            <div id="content">
                <div>	<h2 class="title">Promo Avenger</h2>
                    <div class="entry">
                        <form action="<?php echo base_url();?>form_control_penjualan/insertPromoTebus" method="post" name="frmjual" id="frmjual">
                                ...
                                <tr>
                                    ...
                                    <td >&nbsp;<?php echo $cabang; ?>
                                        <input type="hidden" name="token" size="30" readonly="readonly" value="<?php echo $setToken; ?>">
										 ...
										 <input type="hidden" name="halaman" size="30" readonly="readonly" value="<?php echo $pencarian; ?>">
                ...
                <input type="hidden" name="nota_intno_nota" size="20" value="<?php echo $max_id?>" readonly/>
                                ...
                                <tr>
                                  <td>&nbsp;Reguler</td>
                                  <td>&nbsp;
                                 <input type="hidden" name="nota_intid_jpenjualan" id="nota_intid_jpenjualan" size="20" value="31" readonly/>
            			</td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
